...
def register():
    ...
    if form.accepts(request.vars, session):
        ...
        # Insert Email
        db.pr_contact.insert(pe_id=pe_id, contact_method=1, value=request.vars.email)
        # Insert Telephone
        db.pr_contact.insert(pe_id=pe_id, contact_method=2, value=request.vars.telephone)
