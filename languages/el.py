...
'Background Colour': 'Χρώμα υποβάθρου',
...
'Colour of Buttons when hovering': 'Χ΄ρωμα των κουμπιών όταν υπάρχει μετακίνηση ποντικιού από πάνω',
...
'Text': 'Κείμενο',
'Text Colour for Text blocks': 'Χρώμα κειμένου για τις περιοχές-κουτιά κειμένου',
