...
'Click on the link http://127.0.0.1:8000/eden/default/user/verify_email/%(key)s to verify your email': 'Click on the link http://127.0.0.1:8000/eden/default/user/verify_email/%(key)s to verify your email',
'Client IP': 'Client IP',
...
'Failed to send mail to Approver (%s)- see if you can notify them manually!': 'Failed to send mail to Approver (%s)- see if you can notify them manually!',
'Failed to send mail to Approver (useradmin@your.org)- see if you can notify them manually!': 'Failed to send mail to Approver (useradmin@your.org)- see if you can notify them manually!',
