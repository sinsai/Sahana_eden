...
'A item which can be used in place of another item': 'A item which can be used in place of another item',
...
"If you donï¿½t see the Office in the list, you can add a new one by clicking link 'Add Office'.": "If you donï¿½t see the Office in the list, you can add a new one by clicking link 'Add Office'.",
