...
'Add Sender Organization': 'Add Sender Organisation',
...
'Assessments are structured reports done by Professional Organizations': 'Assessments are structured reports done by Professional Organisations',
'Assessments are structured reports done by Professional Organizations - data includes WFP Assessments': 'Assessments are structured reports done by Professional Organisations - data includes WFP Assessments',
'Assessments:': 'Assessments:',
'Assessor': 'Assessor',
...
'Capturing organizational information of a relief organization and all the projects they have in the region': 'Capturing organisational information of a relief organisation and all the projects they have in the region',
...
'For enhanced security, you are recommended to enter a username and password, and notify administrators of other machines in your organization to add this username and password against your UUID in Synchronization -> Sync Partners': 'For enhanced security, you are recommended to enter a username and password, and notify administrators of other machines in your organisation to add this username and password against your UUID in Synchronization -> Sync Partners',
...
'Module stores structured reports done by Professional Organizations - currently data includes WFP Assessments.': 'Module stores structured reports done by Professional Organisations - currently data includes WFP Assessments.',
'Monday': 'Monday',
...
'System is a central online repository where all relief organizations, relief workers, government agents and camp sites for displaced personnel can coordinate the supply of aid with their demand. It allows users to allocate the available resources to fulfill the demands effectively and efficiently.': 'System is a central online repository where all relief organisations, relief workers, government agents and camp sites for displaced personnel can coordinate the supply of aid with their demand. It allows users to allocate the available resources to fulfill the demands effectively and efficiently.',
...
'The Assessments module allows field workers to send in assessments. 2 different options are provided here currently:': 'The Assessments module allows field workers to send in assessments. 2 different options are provided here currently:',
...
'The Organization this record is associated with.': 'The Organisation this record is associated with.',
'The Organization which is funding this Activity.': 'The Organisation which is funding this Activity.',
...
'The Rapid Assessments Module stores structured reports done by Professional Organizations.': 'The Rapid Assessments Module stores structured reports done by Professional Organisations.',
...
"The Sector(s) this organization works in. Multiple values can be selected by holding down the 'Control' key.": "The Sector(s) this organisation works in. Multiple values can be selected by holding down the 'Control' key.",
...
'The contact person for this organization.': 'The contact person for this organisation.',
...
'Your action is required. Please approve user 1@h.com asap: ': 'Your action is required. Please approve user 1@h.com asap: ',
'Your action is required. Please approve user 1@m.com asap: ': 'Your action is required. Please approve user 1@m.com asap: ',
'Your action is required. Please approve user 2@h.com asap: ': 'Your action is required. Please approve user 2@h.com asap: ',
'Your action is required. Please approve user 3@h.com asap: ': 'Your action is required. Please approve user 3@h.com asap: ',
'Your action is required. Please approve user 4@h.com asap: ': 'Your action is required. Please approve user 4@h.com asap: ',
'Your action is required. Please approve user 5@h.com asap: ': 'Your action is required. Please approve user 5@h.com asap: ',
'Your action is required. Please approve user 6@h.com asap: ': 'Your action is required. Please approve user 6@h.com asap: ',
'Your action is required. Please approve user 7@h.com asap: ': 'Your action is required. Please approve user 7@h.com asap: ',
'Your action is required. Please approve user 9@h.com asap: ': 'Your action is required. Please approve user 9@h.com asap: ',
'Your action is required. Please approve user foo@aidiq.com asap: ': 'Your action is required. Please approve user foo@aidiq.com asap: ',
'Your action is required. Please approve user jim@aidiq.com asap: ': 'Your action is required. Please approve user jim@aidiq.com asap: ',
...
'meters': 'meters',
'module allows the an inspector to fill information for buildings.': 'module allows the an inspector to fill information for buildings.',
