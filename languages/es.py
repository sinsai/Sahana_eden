...
'Colour of dropdown menus': 'Color de los menús desplegables',
...
'Delete Projection': 'Eliminar Projección',
...
'Edit Application': 'Edición de aplicación',
...
'How many houses are uninhabitable (uninhabitable = foundation and structure destroyed)?': 'Cuantas casas están inhabitables (inhabitable=cimientos y estructuras destruidas)?',
...
"If this setting is enabled then all deleted records are just flagged as deleted instead of being really deleted. They will appear in the raw database access but won't be visible to normal users.": 'Si este parámetro está habilitado, todos los registros eliminados serán etiquetados como eliminados, en lugar de ser efectivamente eliminados. Aparecerán en la base de datos maestra pero no estarán visibles a los usuarios normales.',
...
'Inventory Item added': 'Insumo agregado al inventario',
...
'Module provides access to information on current Flood Levels.': 'Modulo provee acceso a información acerca de los niveles actuales de inundación.',
...
'No Presence Log Entries currently registered': 'No hay entradas de Presencia actualmente registrados',
...
'Other ways to obtain food': 'Otras formas para obtener comida',
...
'Where are the separated children originally from?': 'Dónde estaban originalmente los niños separados?',
