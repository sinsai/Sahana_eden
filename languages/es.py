...
'Additional quantity quantifier – i.e. “4x5”.': 'Cuantificador adicional - ej. 4x5',
'Address': 'Dirección',
...
'Delete Distribution Item': 'Eliminar Ítem de Distribución',
...
'Incident Report Details': 'Detalles de reporte de incidente',
...
'Layer': 'Capa',
'Layer Details': 'Nombrar detalles',
...
'No Items currently registered': 'No hay ítems registrados actualmente',
...
'No Presence Log Entries currently registered': 'No se registran entradas al sistema actualmente',
...
'Other alternative infant nutrition in use': 'Otra nutrición infantil alternativa en uso',
...
'The post variable on the URL used for sending messages': 'El nombre varia sobre la URL usada para enviar mensajes',
...
'This form allows the administrator to remove a duplicate location by 1st updating all references to it by a different location.': 'Este formulario permite al administrador eliminar una ubicación duplicada actualizando primero todas las referencias a él por una ubicación diferente.',
