...
'Module stores structured reports done by Professional Organizations - currently data includes WFP Assessments.': 'Reportes estructurados sobre módulos de almacenamiento realizado por Organizaciones Profesionales - datos actualmente influyen Evaluación WFP.',
'Moldova': 'Moldavia',
'Monaco': 'Mónaco',
'Monday': 'Lunes',
'Mongolia': 'Mongolia',
