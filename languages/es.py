...
'# of International Staff': '# de Empleados Internacionales',
...
'Add Cholera Treatment Capability Information': 'Agregar Información sobre Capacidad de Tratamiento Cólera',
...
'Add New Need': 'agregar una  nueva necesidad ',
...
'Add New Warehouse': 'agregar un nuevo almacén',
...
'Allowed to push': 'Se puede empujar',
...
'Basic Assessment Reported': 'Asesoría Básica Reportada',
...
'Bed type already registered': 'el tipo de camas ya estan registradas',
...
'Check outbox for the message status': 'Verificar bandeja de salida para estado de mensaje',
...
'Cluster Subsector': 'subsectores de grupos',
...
'Conflict Details': 'Detalles de Conflicto',
...
'Delete Baseline': 'Borrar Línea Base',
...
'Delete Impact Type': 'Eliminar Tipo de Impacto',
...
'Delete Warehouse': 'Borrar Almacén',
...
'Edit Peer Details': 'Editar Detalles Similares',
...
'Edit Received Shipment': 'Editar pedido recibido',
...
'Edit Request': 'editar requerimiento',
...
'Find': 'Buscar',
'Find Dead Body Report': 'Encontrar el reporte de los cadaveres',
...
'If this record should be restricted then select which role is required to access the record here.': 'Si este record debe ser restringido, entonces seleccione que rol  se requiere para acceder al record aquí.',
...
'Impact updated': 'impacto de la actualización',
'Impacts': 'Impacts',
'Import': 'Importación',
...
'Improper handling of dead bodies': 'Manejo no apropiado de cadáveres',
...
'Last updated on': 'última catualización',
'Latitude': 'Latitud',
...
'List': 'Lista',
'List ': 'Lista',
'List / Add Baseline Types': 'Lista/Añadir tipos de referencia',
...
'List Received Items': 'Lista Insumos Recibidos',
...
'Need Type added': 'Tipo Necesidad añadido',
...
'No Baselines currently registered': 'Actualmente no hay lineas base registradas',
...
'No Cluster Subsectors currently registered': 'En la actualidad no hay un Grupo de Subsectores registrados ',
...
'No Needs currently registered': 'No hay Necesidades registradas actualmente',
...
'No Requests have been made yet': 'Aún no se han hecho ningunos requerimientos',
...
'No Warehouses currently registered': 'Actualmente no hay naves industriales registradas',
...
'On by default? (only applicable to Overlays)': 'Activada por defecto? (sólo aplicable a superposiciones)',
...
'People Needing Shelter': 'Personas Necesitando Albergues ',
...
'Person': 'Persona',
'Person 1': 'Person 1',
'Person 1, Person 2 are the potentially duplicate records': 'Persona 1, Persona 2, son potencialmente las grabaciones duplicadas',
'Person 2': 'Person 2',
...
'RECORD A': 'GRABACIÓN A',
'RECORD B': 'GRABACIÓN  B',
'RESPONSE': 'RESPONSE',
...
'Rapid Assessment deleted': 'evaluación rapida eliminada',
'Rapid Assessment updated': 'Rapid Assessment updated',
'Rapid Assessments': 'Evaluaciones Rápidas',
'Rapid Assessments & Flexible Impact Assessments': 'Evaluaciones Rápidas & Evaluaciones Flexibles de Impacto',
...
'Receive Shipment': 'paquete recibido',
'Received': 'Received',
...
'Report': 'Informe',
'Report Another Assessment...': 'reporatr otra evaluación',
...
'Report them as found': 'Reportarlos como encontrados',
...
'Request Updated': 'Solicitud de Actualización',
'Request added': 'Request added',
...
'Sahana access granted': 'Acceso de Sahana concedido',
...
'Sahana: new request has been made. Please login to see if you can fulfil the request.': 'Sahana; Nueva petición ha sido realizada. Porfavor inicie sesión para verificar petición en detalle. ',
...
'Search Baseline Type': 'buscar el tipo de linea base',
...
'Search Impact Type': 'buscar el tipo de impacto',
'Search Impacts': 'buscar impactos',
...
'Search Needs': 'Necesidades de Búsqueda',
...
'Site Description': 'Descripción Locación',
...
'Sorry, there are no addresses to display': 'Lo sentimos, no hay dirección para mostrar',
...
'The Location the Person is going to, which can be general (for Reporting) or precise (for displaying on a Map). Enter a few characters to search from available locations.': 'A la ubicaión a la cual la persona va a ir, puede ser en general ( para reportar) o precisar (para mostrar en un mapa). ingrese pocos caracteres para buscar desde las ubicaciones disponibles.',
...
'To delete': 'To delete',
'To edit OpenStreetMap, you need to edit the OpenStreetMap settings in models/000_config.py': 'Para editar el OpenStreetMap, tienes que modificar la configuración de OpenStreetMap en models/000_config.py',
...
'Tropo settings updated': 'valores actualizados de Tropo',
'Truck': 'Camión',
...
'Volunteer Details': 'Detalles sobre voluntarios',
...
'Volunteer added': 'Voluntarios agregados',
'Volunteer deleted': 'Volunteer deleted',
'Volunteer details updated': 'Detalle sobre voluntario actualizado',
...
'Walking time to the health service': 'Tiempo en camino a servicio de salud',
...
"What are the people's normal ways to obtain food in this area?": 'cuál es la forma  normal en que las personas en esta area  obtienen la comida ?',
