...
'# of People Affected':'Nombre de personnes touch\xc3\xa9es',
...
'Add Skill Types':'Ajouter genres de comp\xc3\xa9tence',
'Add Skill':'Add Skill',
...
'Additional quantity quantifier \xe2\x80\x93 i.e. \xe2\x80\x9c4x5\xe2\x80\x9d.':'Additional quantity quantifier \xe2\x80\x93 i.e. \xe2\x80\x9c4x5\xe2\x80\x9d.',
...
'Advanced Location Search':'Recherche avanc\xc3\xa9e Localisation',
...
'Allows authorized users to control which layers are available to the situation map.':'Cela permet aux utilisateurs de contr\xc3\xb4ler les couches sont disponibles \xc3\xa0 la carte de situation.',
...
'Complete Unit Label for e.g. meter for m.':'Unit\xc3\xa9 compl\xc3\xa8te Label pour par exemple m\xc3\xa8tre pour m.',
'Completed':'Completed',
...
'Entering a phone number is optional, but doing so allows you to subscribe to receive SMS messages.':"Saisie d'un num\xc3\xa9ro de t\xc3\xa9l\xc3\xa9phone est facultatif, mais cela permet donc de vous abonner pour recevoir des messages SMS.",
'Equipment':'Equipment',
...
'For each sync partner, there is a default sync job that runs after a specified interval of time. You can also set up more sync jobs which could be customized on your needs. Click the link on the right to get started.':"Pour chaque partenaire de synchronisation, il ya un travail de synchronisation par d\xc3\xa9faut qui s'ex\xc3\xa9cute apr\xc3\xa8s un intervalle de temps sp\xc3\xa9cifi\xc3\xa9. Vous pouvez \xc3\xa9galement configurer la synchronisation des emplois plus qui pourrait \xc3\xaatre personnalis\xc3\xa9s \xc3\xa0 vos besoins. Cliquez sur le lien \xc3\xa0 droite pour commencer.",
...
'Global Messaging Settings':'Param\xc3\xa8tres globaux de messagerie',
'Goatee':'Goatee',
...
'Health center':'Centre de sant\xc3\xa9',
'Health':'Health',
...
'Hospital information added':"l'information a ajout\xc3\xa9 l'h\xc3\xb4pital",
...
'Inventory Item added':'Inventaire item a \xc3\xa9t\xc3\xa9 ajout\xc3\xa9',
...
'Item Sub-Category updated':"Sous-cat\xc3\xa9gorie de l'objet mis \xc3\xa0 jour",
...
'List':'List',
'List/Add':'List/Add',
'Lists "who is doing what & where". Allows relief agencies to coordinate their activities':'Listes "qui fait quoi et o\xc3\xb9". organismes de secours permet de coordonner leurs activit\xc3\xa9s',
'Live Help':'Live Help',
...
'Location deleted':'Lieu supprim\xc3\xa9',
'Location details':'Location details',
...
'No Category<>Sub-Category<>Catalog Relation currently registered':'Pas de cat\xc3\xa9gorie <> Sous-cat\xc3\xa9gorie de relation <Catalogue> actuellement enregistr\xc3\xa9s',
...
'No Hospitals currently registered':"Pas d'h\xc3\xb4pitaux actuellement enregistr\xc3\xa9s",
...
'No Memberships currently defined':'Aucun Membre de la d\xc3\xa9finition actuelle',
...
'Request Item deleted':'Demande Point supprim\xc3\xa9',
...
'Shelter Services':"Les services d'h\xc3\xa9bergement",
...
'Survey Template added':'Enqu\xc3\xaate Mod\xc3\xa8le ajout\xc3\xa9',
...
'System keeps track of all Volunteers working in the disaster region. It captures not only the places where they are active, but also captures information on the range of services they are providing in each area.':"Syst\xc3\xa8me garde une trace de tous les volontaires travaillant dans la r\xc3\xa9gion sinistr\xc3\xa9e. Il capte non seulement les lieux o\xc3\xb9 ils sont actifs, mais il prend aussi des informations sur la gamme des services qu'ils offrent dans chaque zone.",
'Tags':'Tags',
...
'The post variable on the URL used for sending messages':"La variable post sur l'URL utilis\xc3\xa9e pour envoyer des messages",
...
'Title':'Title',
'To begin the sync process, click the button on the right => ':'Pour commencer le processus de synchronisation, cliquez sur le bouton \xc3\xa0 droite =>',
...
'Update if Master':'Mettre \xc3\xa0 jour si Master',
...
'Urdu':'Urdu',
'Use (...)&(...) for AND, (...)|(...) for OR, and ~(...)  for NOT to build more complex queries.':'Utilisez (...)&(...) pour ET, OU pour (...)|(...), et ~(...) Pour ne pas cr\xc3\xa9er des requ\xc3\xaates plus complexes.',
