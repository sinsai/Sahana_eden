...
'Donor added': '資金提供者を追加しました',
'Donor deleted': '資金提供者を削除しました',
'Donor updated': '資金提供者を更新しました',
'Donors': '資金提供者',
...
'Funeral': '葬儀',
'Further Action Recommended': '更なる対応策をお勧めします',
...
'Intergovernmental Organization': '政府間組織',
...
'Message sent to outbox': 'メッセージをoutboxに送りました',
...
'No Sectors currently registered': '登録済みのセクターがありません',
...
'People Needing Shelter': '避難所が必要な人たち',
...
'Sections': 'セクション',
'Sector': 'セクター',
'Sector Details': 'セクターの詳細',
'Sector added': 'セクターを追加しました',
'Sector deleted': 'セクターを削除しました',
'Sector updated': 'セクターを更新しました',
'Sectors': 'セクター',
...
'Sorry, only users with the MapAdmin role are allowed to create location groups.': '申し訳ありませんが、 MapAdmin 権限をを持つユーザだけがロケーションのグループを作れます',
