...
'# Houses Damaged': '損壊した住宅数',
'# Houses Flooded': '# Houses Flooded',
'# People Needing Food': '# People Needing Food',
'# People at Risk From Vector-Borne Diseases': '# People at Risk From Vector-Borne Diseases',
'# People without Access to Safe Drinking-Water': '# People without Access to Safe Drinking-Water',
...
'Enter a GPS Coordinate': 'GPS Coordinate を入力',
...
'If a user verifies that they own an Email Address with this domain, then they should automatically be assigned to this Organisation. The Approver field is used to determine whether & by whom further approval is required.': 'If a user verifies that they own an Email Address with this domain, then they should automatically be assigned to this Organisation. The Approver field is used to determine whether & by whom further approval is required.',
...
'WatSan': '水供給',
'Water': '水',
'Water Level still high?': 'Water Level still high?',
'Water Level still high?:': 'Water Level still high?:',
