...
'For enhanced security, you are recommended to enter a username and password, and notify administrators of other machines in your organization to add this username and password against your UUID in Synchronization -> Sync Partners': 'セキュリティ向上のため、ユーザー名とパスワードを入力し、団体の他端末の管理者にユーザー名とパスワードを通知して「Synchronization」 -> 「Sync Partners」であなたのUUIDに追加してもらうことを推奨します。',
...
'No matching items for this request': 'No matching items for this request',
...
'Pounds': 'ポンド',
'Power Failure': '停電',
'Powered by Sahana Eden': 'Sahana Edenを使っています',
...
'Sahana Eden is a family of applications that provide solutions to coordination and collaboration for organisations working in disaster management.': 'Sahana Edenは、災害復旧に関わる様々な支援団体が、お互いに協力しあうために存在します。',
...
'Upload an image file (bmp, gif, jpeg or png), max. 300x300 pixels!': '画像ファイルをアップロード(bmp,gif,jpeg,png) 最大30x300ピクセル',
