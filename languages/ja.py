...
'Assessments': 'アセスメント',
'Assessments Needs vs. Activities': '需要調査と支援活動のギャップ',
...
'Available for Location': 'ロケーションとして使用可能',
...
'For other types, the next screen will allow you to enter the relevant details...': 'For other types, the next screen will allow you to enter the relevant details...',
'For:': '対象:',
'Forest Fire': '森林火災',
'Formal camp': '指定避難所',
'Format': 'フォーマット',
...
'Inventory': '在庫',
'Inventory Item': '備蓄中の物資',
'Inventory Item Details': '救援物資の在庫詳細',
'Inventory Item added': '救援物資を追加しました',
'Inventory Item deleted': '物資在庫を削除しました',
'Inventory Item updated': '物資在庫を更新しました',
'Inventory Items': '物資在庫',
'Inventory Management': '物流の管理',
'Inventory Store': '物資備蓄地点',
'Inventory Store Details': '物資備蓄地点の詳細',
'Inventory Store added': '物資備蓄地点を追加しました',
'Inventory Store deleted': '物資備蓄地点を削除しました',
'Inventory Store updated': '物資備蓄地点を更新しました',
...
'Select Items from this Inventory': 'この在庫のなかから物資を検索',
...
'Select to show this configuration in the Regions menu.': 'Select to show this configuration in the Regions menu.',
...
'Shipment Items received by Inventory': '物資の輸送が完了し、在庫を追加しました',
'Shipment Items sent from Inventory': '輸送物資を備蓄から送りました',
...
'Show Details': '詳細を表示',
'Show Map': '地図の表示',
'Show Region in Menu?': 'Show Region in Menu?',
'Show on map': '地図上に表示',
...
'Term for the secondary within-country administrative division (e.g. District).': 'Term for the secondary within-country administrative division (e.g. District).',
...
'There are not sufficient items in the Inventory to send this shipment': 'この輸送を開始するために十分な物資が備蓄にありません',
...
'This shipment will be confirmed as received.': 'この輸送された物資は、受信したと確認されます',
'This value adds a small mount of distance outside the points. Without this, the outermost points would be on the bounding box, and might not be visible.': 'This value adds a small mount of distance outside the points. Without this, the outermost points would be on the bounding box, and might not be visible.',
'This value gives a minimum width and height in degrees for the region shown. Without this, a map showing a single point would not show any extent around that point. After the map is displayed, it can be zoomed as desired.': 'This value gives a minimum width and height in degrees for the region shown. Without this, a map showing a single point would not show any extent around that point. After the map is displayed, it can be zoomed as desired.',
'Thunderstorm': '雷雨',
'Thursday': '木曜日',
'Ticket': 'チケット',
