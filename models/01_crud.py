...
anything we would have passed via linkto in prep.  Ask me how I know.
...
One question is:  If some components have components, and others don't,
is it better to send all of them to their native pages?  Or ok to leave
the simple components as-is?
...
def shn_component_postp(r, output):
    ...
    if r.component and s3xrc.model.has_components(r.component.prefix,
        ...
        listadd = not r.attr or r.attr.get("listadd", True)
