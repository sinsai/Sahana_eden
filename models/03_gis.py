...
table.L1.comment = DIV(
    ...
    _title="%s|%s" % (
        ...
        T("Term for the primary within-country administrative division (e.g. Province).")))
...
table.L4.comment = DIV(
    ...
    _title="%s|%s" % (
        ...
        T("Term for the fourth-level within-country administrative division (e.g. Neighborhood or Precinct).")))
