...
db[table].type.represent = lambda opt: or_organisation_type_opts.get(opt, T('Unknown'))
...
db[table].country.represent = lambda opt: shn_list_of_nations.get(opt, T('Unknown'))
...
db[table].type.represent = lambda opt: or_office_type_opts.get(opt, T('Unknown'))
db[table].type.label = T('Type')
