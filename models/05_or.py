...
db[table].organisation.comment = DIV(A(s3.crud_strings.or_organisation.label_create_button, _class='thickbox', _href=URL(r=request, c='or', f='organisation', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Organisation|The Organisation this Office belongs to.")))
