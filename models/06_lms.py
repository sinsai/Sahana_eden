...
if deployment_settings.has_module(module):
    ...
    table.base_unit.comment = DIV( _class="tooltip", _title=T("Base Unit") + "|" + T("The entered unit links to this unit. For e.g. if you are entering m for meter then choose kilometer(if it exists) and enter the value 0.001 as multiplicator."))
    table.multiplicator.comment = DIV( _class="tooltip", _title=T("Multiplicator") + "|" + T("If Unit = m, Base Unit = Km, then multiplicator is 0.0001 since 1m = 0.001 km."))
    ADD_UNIT = T("Add Unit")
    ...
    table.name.comment = DIV( _class="tooltip", _title=T("Site Location Name") + "|" + T("A place within a Site like a Shelf, room, bin number etc."))
    ...
    table.number.comment = DIV( _class="tooltip", _title=T("Storage Bin Number") + "|" + T("Identification label of the Storage bin."))
