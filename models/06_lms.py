...
if deployment_settings.has_module(module):
    ...
    table.capacity_unit.comment = DIV(A(T('Add Unit'), _class='colorbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
    table.weight_unit.requires = IS_ONE_OF(db, "lms_unit.id", "%(name)s", filterby='opt_lms_unit_type', filter_opts=[2])
    table.weight_unit.comment = DIV(A(T('Add Unit'), _class='colorbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
    table.site_id.comment = DIV(A(T('Add Site'), _class='colorbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Site|Add the main Warehouse/Site information where this Storage location is.")))
    ...
    table.site_id.comment = DIV(A(T('Add Site'), _class='colorbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Site|Add the main Warehouse/Site information where this Bin belongs to.")))
    ...
    table.bin_type.comment = DIV(A(T('Add Storage Bin Type'), _class='colorbox', _href=URL(r=request, c='lms', f='storage_bin_type', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Storage Bin|Add the Storage Bin Type.")))
    table.storage_id.requires = IS_IN_DB(db, 'lms_storage_loc.id', 'lms_storage_loc.name')
    table.storage_id.comment = DIV(A(T('Add Storage Location'), _class='colorbox', _href=URL(r=request, c='lms', f='storage_loc', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Storage Location|Add the Storage Location where this bin is located.")))
    ...
    table.parent_category.comment = DIV(A(T('Add Item Category'), _class='colorbox', _href=URL(r=request, c='lms', f='catalog_cat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Category.")))
    ...
    table.category_id.comment = DIV(A(T('Add Item Category'), _class='colorbox', _href=URL(r=request, c='lms', f='catalog_cat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Category.")))
    ...
    table.subcategory_id.comment = DIV(A(T('Add Item Sub-Category'), _class='colorbox', _href=URL(r=request, c='lms', f='catalog_subcat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Sub-Category.")))
    ...
    table.catalog_id.comment = DIV(A(T('Add Item Catalog'), _class='colorbox', _href=URL(r=request, c='lms', f='catalog', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Catalog.")))
    ...
    table.sender_site.comment = DIV(A(T('Add Sender Site'), _class='colorbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Site|Add a new Site from where the Item is being sent.")))
    table.recipient_site.requires = IS_IN_DB(db, 'lms_site.id', 'lms_site.name')
    table.recipient_site.comment = DIV(A(T('Add Recipient Site'), _class='colorbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Recipient|Add a new Site where the Item is being sent to.")))
    ...
    table.site_id.label = T("Site/Warehouse")
    table.site_id.comment = DIV(A(T('Add Site'), _class='colorbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Site|Add the main Warehouse/Site information where this Item is to be added.")))
    table.quantity_unit.requires = IS_ONE_OF(db, "lms_unit.id", "%(name)s", filterby='opt_lms_unit_type', filter_opts=[5])
    table.quantity_unit.comment = DIV(A(T('Add Unit'), _class='colorbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
    table.specifications_unit.requires = IS_ONE_OF(db, "lms_unit.id", "%(name)s", filterby='opt_lms_unit_type', filter_opts=[1])
    table.specifications_unit.comment = DIV(A(T('Add Unit'), _class='colorbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
    table.weight_unit.requires = IS_ONE_OF(db, "lms_unit.id", "%(name)s", filterby='opt_lms_unit_type', filter_opts=[2])
    table.weight_unit.comment = DIV(A(T('Add Unit'), _class='colorbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
    table.name.requires = IS_NOT_EMPTY()
    table.way_bill.comment = SPAN("*", _class="req")
    ...
    table.category.comment = DIV(A(T('Add Item Category'), _class='colorbox', _href=URL(r=request, c='lms', f='catalog_cat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Category.")))
    table.sub_category.requires = IS_IN_DB(db, 'lms_catalog_subcat.id', 'lms_catalog_subcat.name')
    table.sub_category.comment = DIV(A(T('Add Item Sub-Category'), _class='colorbox', _href=URL(r=request, c='lms', f='catalog_subcat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Sub-Category.")))
    table.sender_site.requires = IS_IN_DB(db, 'lms_site.id', 'lms_site.name')
    table.sender_site.comment = DIV(A(T('Add Sender Organisation'), _class='colorbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Sender Site.")))
    table.recipient_site.requires = IS_IN_DB(db, 'lms_site.id', 'lms_site.name')
    table.recipient_site.comment = DIV(A(T('Add Recipient Site'), _class='colorbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Recipient Site.")))
