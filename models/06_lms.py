...
# db[table].site_category_id.comment = DIV(A(T('Add Category'), _class='thickbox', _href=URL(r=request, c='lms', f='site_category', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Site Category|The Category of Site.")))
db[table].name.label = T("Site Name")
DIV(A(T('Add Site'), _class='thickbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Site|Add the main Warehouse/Site information where this Storage location is.")))
...
db[table].organisation.comment = DIV(A(T('Add Organisation'), _class='thickbox', _href=URL(r=request, c='or', f='organisation', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Sender|Add sender to which the site belongs to.")))
...
db[table].capacity_unit.comment = DIV(A(T('Add Unit'), _class='thickbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
...
db[table].weight_unit.comment = DIV(A(T('Add Unit'), _class='thickbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
db[table].site_id.comment = DIV(A(T('Add Site'), _class='thickbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Site|Add the main Warehouse/Site information where this Storage location is.")))
...
db[table].site_id.comment = DIV(A(T('Add Site'), _class='thickbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Site|Add the main Warehouse/Site information where this Bin belongs to.")))
...
db[table].storage_id.comment = DIV(A(T('Add Storage Location'), _class='thickbox', _href=URL(r=request, c='lms', f='storage_loc', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Storage Location|Add the Storage Location where this this Bin belongs to.")))
...
db[table].bin_type.comment = DIV(A(T('Add Storage Bin Type'), _class='thickbox', _href=URL(r=request, c='lms', f='storage_bin_type', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Storage Bin|Add the Storage Bin Type.")))
db[table].storage_id.requires = IS_IN_DB(db, 'lms_storage_loc.id', 'lms_storage_loc.name')
db[table].storage_id.comment = DIV(A(T('Add Storage Location'), _class='thickbox', _href=URL(r=request, c='lms', f='storage_loc', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Storage Location|Add the Storage Location where this bin is located.")))
...
db[table].uuid.requires = IS_NOT_IN_DB(db,'%s.uuid' % table)
db[table].organisation.requires = IS_IN_DB(db, 'or_organisation.id', 'or_organisation.name')
db[table].organisation.comment = DIV(A(T('Add Organisation'), _class='thickbox', _href=URL(r=request, c='or', f='organisation', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Organisation|Add the name and additional information about the Organisation if it does not exists already.")))
db[table].name.requires = IS_NOT_EMPTY()
...
db[table].parent_category.comment = DIV(A(T('Add Item Category'), _class='thickbox', _href=URL(r=request, c='lms', f='catalog_cat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Category.")))
...
db[table].category_id.comment = DIV(A(T('Add Item Category'), _class='thickbox', _href=URL(r=request, c='lms', f='catalog_cat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Category.")))
...
db[table].subcategory_id.comment = DIV(A(T('Add Item Sub-Category'), _class='thickbox', _href=URL(r=request, c='lms', f='catalog_subcat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Sub-Category.")))
...
db[table].catalog_id.comment = DIV(A(T('Add Item Catalog'), _class='thickbox', _href=URL(r=request, c='lms', f='catalog', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Catalog.")))
...
db[table].sender_site.comment = DIV(A(T('Add Sender Site'), _class='thickbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Site|Add a new Site from where the Item is being sent.")))
db[table].recipient_site.requires = IS_IN_DB(db, 'lms_site.id', 'lms_site.name')
db[table].recipient_site.comment = DIV(A(T('Add Recipient Site'), _class='thickbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Recipient|Add a new Site where the Item is being sent to.")))
...
db[table].site_id.label = T("Site/Warehouse")
db[table].site_id.comment = DIV(A(T('Add Site'), _class='thickbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Site|Add the main Warehouse/Site information where this Item is to be added.")))
...
db[table].quantity_unit.comment = DIV(A(T('Add Unit'), _class='thickbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
...
db[table].specifications_unit.comment = DIV(A(T('Add Unit'), _class='thickbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
db[table].weight_unit.requires = IS_ONE_OF(db, "lms_unit.id", "%(name)s", filterby='opt_lms_unit_type', filter_opts=[2])
#db[table].weight_unit.requires=IS_UNIT(db, filter_opts=[2])
db[table].weight_unit.comment = DIV(A(T('Add Unit'), _class='thickbox', _href=URL(r=request, c='lms', f='unit', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Unit|Add the unit of measure if it doesnt exists already.")))
...
db[table].category.comment = DIV(A(T('Add Item Category'), _class='thickbox', _href=URL(r=request, c='lms', f='catalog_cat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Category.")))
db[table].sub_category.requires = IS_IN_DB(db, 'lms_catalog_subcat.id', 'lms_catalog_subcat.name')
db[table].sub_category.comment = DIV(A(T('Add Item Sub-Category'), _class='thickbox', _href=URL(r=request, c='lms', f='catalog_subcat', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add main Item Sub-Category.")))
db[table].sender_site.requires = IS_IN_DB(db, 'lms_site.id', 'lms_site.name')
db[table].sender_site.comment = DIV(A(T('Add Sender Organisation'), _class='thickbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Sender Site.")))
db[table].recipient_site.requires = IS_IN_DB(db, 'lms_site.id', 'lms_site.name')
db[table].recipient_site.comment = DIV(A(T('Add Recipient Site'), _class='thickbox', _href=URL(r=request, c='lms', f='site', args='create', vars=dict(format='popup')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Add Recipient Site.")))
