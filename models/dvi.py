...
#comments
db[table].personal_effects.comment = DIV(A(T('Add Details'), _class='popup', _href=URL(r=request, c='dvi', f='personal_effects', args='create', vars=dict(format='plain')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Personal Effects|Record data about personal belongings")))
db[table].body_radiology.comment = DIV(A(T("Add Details"), _class='popup', _href=URL(r=request, c='dvi', f='radiology', args='create', vars=dict(format='plain')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Radiology|Record Radiology data.")))
db[table].fingerprints.comment = DIV(A(T("Add Details"), _class='popup', _href=URL(r=request, c='dvi', f='fingerprints', args='create', vars=dict(format='plain')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Fingerprints Details|Record fingerprint data .")))
db[table].anthropology.comment = DIV(A(T("Add Details"), _class='popup', _href=URL(r=request, c='dvi', f='anthropology', args='create', vars=dict(format='plain')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Anthroplogy|Record Anthropology details.")))
db[table].pathology.comment = DIV(A(T("Add Details"), _class='popup', _href=URL(r=request, c='dvi', f='pathology', args='create', vars=dict(format='plain')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Pathology|Record Pathology Details.")))
db[table].dna.comment = DIV(A(T("Add Details"), _class='popup', _href=URL(r=request, c='dvi', f='dna', args='create', vars=dict(format='plain')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("DNA Exam|Record DNA Exam Details.")))
db[table].dental.comment = DIV(A(T("Add Details"), _class='popup', _href=URL(r=request, c='dvi', f='dental', args='create', vars=dict(format='plain')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Dental|Record Dental Examination Details.")))
