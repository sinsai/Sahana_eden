...
msg_group_id = SQLTable(None, 'msg_group_id',
            Field('msg_group_id', db.msg_group,
                ...
                label = T('Group'),
                #comment = DIV(A(T('Add Group'), _class='popup', _href=URL(r=request, c='msg', f='group', args='create', vars=dict(format='plain', KeepThis='true', TB_iframe='true', height=190, width=350)), _target='top', _title=T('Add Group')), A(SPAN("[Help]"), _class="tooltip", _title=T("Distribution Group|The Group of People to whom this Message should be sent."))),
                comment = DIV(A(T('Add Group'), _class='popup', _href=URL(r=request, c='msg', f='group', args='create', vars=dict(format='plain', KeepThis='true')), _target='top', _title=T('Add Group')), A(SPAN("[Help]"), _class="tooltip", _title=T("Distribution Group|The Group of People to whom this Message should be sent."))),
                ondelete = 'RESTRICT'
                ))
