...
group_id = SQLTable(None, 'group_id',
            Field('group_id', db.msg_group,
                ...
                label = T('Group'),
                comment = DIV(A(T('Add Group'), _class='thickbox', _href=URL(r=request, c='msg', f='group', args='create', vars=dict(format='popup'))+"&KeepThis=false&TB_iframe=true&height=190&width=350", _target='top',_title=T('Add Group')), A(SPAN("[Help]"), _class="tooltip", _title=T("Distribution Group|The Group of People to whom this Message should be sent."))),
                ondelete = 'RESTRICT'
                ))
