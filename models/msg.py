...
msg_group_id = SQLTable(None, 'msg_group_id',
            Field('msg_group_id', db.msg_group,
                ...
                comment = DIV(A(T('Add Group'), _class='thickbox', _href=URL(r=request, c='msg', f='group', args='create', vars=dict(format='popup', KeepThis='true')), _target='top'), A(SPAN("[Help]"), _class="tooltip", _title=T("Distribution Group|The Group of People to whom this Message should be sent."))),
                ondelete = 'RESTRICT'
                ))
