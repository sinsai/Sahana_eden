...
#Add module to s3_module table (see /models/01_module.py) to use:
...
s3.crud_strings[tablename] = shn_crud_strings("Disaster") #creates heading for the table (see /models/00_util.py)
