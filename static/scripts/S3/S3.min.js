...
$('.confirmation').click(function(){$(this).fadeOut('slow');return false;});$('a.popup').click(function(){var url=$(this).attr('href');var caller=$(this).parents('tr').attr('id').replace(/__row/,'');return false;});});