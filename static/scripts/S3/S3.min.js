...
$.getJSONS3(this_url,gis_load_locations,false);$('#gis_location_L'+level).removeClass('hidden').show();$('#gis_location_label_L'+level).removeClass('hidden').show();if((''==$('#gis_location_lat').val()||''==$('#gis_location_lon').val())&&(''==$('#gis_location_addr_street').val())){if(''!=new_id){$('#'+gis_location_id).val(new_id);}}
for(l=level+1;l<=5;l=l+1){$('#gis_location_L'+l).hide().html(gis_loading_locations);$('#gis_location_label_L'+l).hide();}}
$(function(){$('#gis_location_L0').change(function(){gis_dropdown_select(1);});$('#gis_location_L1').change(function(){gis_dropdown_select(2);});$('#gis_location_L2').change(function(){gis_dropdown_select(3);});$('#gis_location_L3').change(function(){gis_dropdown_select(4);});$('#gis_location_L4').change(function(){gis_dropdown_select(5);});$('#gis_location_add-btn').click(function(){$('#gis_location_add-btn').hide();$('#gis_location_geolocate-btn').removeClass('hidden').show();$('#gis_location_map-btn').removeClass('hidden').show();$('#gis_location_name_label').removeClass('hidden').show();$('#gis_location_name').removeClass('hidden').show();$('#gis_location_addr_street_label').removeClass('hidden').show();$('#gis_location_addr_street').removeClass('hidden').show();$('#gis_location_geocoder-btn').removeClass('hidden').show();$('#gis_location_advanced_div').removeClass('hidden').show();});$('#gis_location_advanced_checkbox').change(function(){if($('#gis_location_advanced_checkbox').is(':checked')){$('#gis_location_lat_label').removeClass('hidden').show();$('#gis_location_lat_row').removeClass('hidden').show();$('#gis_location_lon_label').removeClass('hidden').show();$('#gis_location_lon_row').removeClass('hidden').show();}else{$('#gis_location_lat_label').hide();$('#gis_location_lat_row').hide();$('#gis_location_lon_label').hide();$('#gis_location_lon_row').hide();}});});var S3MultiselectWidgetFileCounter=0;function S3MultiselectWidgetAddClick(Args)
