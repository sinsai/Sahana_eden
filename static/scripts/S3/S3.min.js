...
return jQuery.getS3(url,data,callback,'json',message,sync);};jQuery.ajaxS3Settings={timeout:10000,msgTimeout:2000,retryLimit:10,dataType:'json',type:'GET'};jQuery.ajaxS3Setup=function(settings){jQuery.extend(jQuery.ajaxS3Settings,settings);};})(jQuery);function StatusBar(sel,options)
...
{return"You have unsaved changes. "+"Click Cancel now, then 'Save' to save them. "+"Click OK now to discard them."};};function ClearNavigateAwayConfirm()
{window.onbeforeunload=function(){};};function EnableNavigateAwayConfirm()
{$(document).ready(function(){$("input, select, textarea").keypress(SetNavigateAwayConfirm);$("input, select, textarea").change(SetNavigateAwayConfirm);$("form").submit(ClearNavigateAwayConfirm);});};