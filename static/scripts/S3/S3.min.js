...
h.preventDefault()});var a={val:$("#gis_location_autocomplete").val(),accept:false};$("#gis_location_autocomplete").autocomplete({source:s3_gis_url+"/search.json?filter=~&field=name&exclude_field=level&exclude_value=XX",minLength:2,focus:function(h,e){$("#gis_location_autocomplete").val(e.item.name);return false},select:function(h,e){$("#gis_location_autocomplete").val(e.item.name);$("#"+s3_gis_location_id).val(e.item.id);a.accept=true;$("ul.ui-autocomplete").hide();$("#gis_location_autocomplete_div").hide();
$("#gis_location_search-btn-label").hide();$("#gis_location_search-btn").show();$("#gis_location_L0_label__row").show();$("#gis_location_L0__row").show();var f=e.item.path,j=e.item.id,b,c,g,k,m=[];switch(e.item.level){case "L0":$("#gis_location_L0").val(j);$("#"+s3_gis_location_id).val(j);s3_gis_dropdown_select(0);break;case "L1":if(f){f=f.split("/");if(f.length==2&&f[1]==j)$("#gis_location_L0").val(f[0]);else{s3_gis_dropdown_select(0,true);$("#gis_location_L1").val(j);$("#"+s3_gis_location_id).val(j);
break}}s3_gis_dropdown_select(0,true);$("#gis_location_L1").val(j);$("#"+s3_gis_location_id).val(j);s3_gis_dropdown_select(1);break;case "L2":if(f){f=f.split("/");if(f.length==3&&f[2]==j){$("#gis_location_L0").val(f[0]);b=f[1]}else if(f.length==2&&f[1]==j)if(undefined!=$("#gis_location_L0 option[value="+f[0]+"]")[0])$("#gis_location_L0").val(f[0]);else b=f[0];else{s3_gis_dropdown_select(1,true);$("#gis_location_L2").val(j);$("#"+s3_gis_location_id).val(j);break}}s3_gis_dropdown_select(0,true);$("#gis_location_L1").val(b);
s3_gis_dropdown_select(1,true);$("#gis_location_L2").val(j);$("#"+s3_gis_location_id).val(j);s3_gis_dropdown_select(2);break;case "L3":if(f){f=f.split("/");if(f.length==4&&f[3]==j){$("#gis_location_L0").val(f[0]);b=f[1];c=f[2]}else if(f.length==3&&f[2]==j)if(undefined!=$("#gis_location_L0 option[value="+f[0]+"]")[0]){$("#gis_location_L0").val(f[0]);m=[f[1]]}else{b=f[0];c=f[1]}else if(f.length==2&&f[1]==j)if(undefined!=$("#gis_location_L0 option[value="+f[0]+"]")[0])$("#gis_location_L0").val(f[0]);
else m=[f[0]];else{s3_gis_dropdown_select(2,true);$("#gis_location_L3").val(j);$("#"+s3_gis_location_id).val(j);break}}s3_gis_dropdown_select(0,true);if(m[0])if(undefined!=$("#gis_location_L1 option[value="+m[0]+"]")[0])b=m[0];$("#gis_location_L1").val(b);s3_gis_dropdown_select(1,true);if(m[0])if(undefined!=$("#gis_location_L2 option[value="+m[0]+"]")[0])c=m[0];$("#gis_location_L2").val(c);s3_gis_dropdown_select(2,true);$("#gis_location_L3").val(j);$("#"+s3_gis_location_id).val(j);s3_gis_dropdown_select(3);
break;case "L4":if(f){f=f.split("/");if(f.length==5&&f[4]==j){$("#gis_location_L0").val(f[0]);b=f[1];c=f[2];g=f[3]}else if(f.length==4&&f[3]==j)if(undefined!=$("#gis_location_L0 option[value="+f[0]+"]")[0]){$("#gis_location_L0").val(f[0]);m=[f[1],f[2]]}else m=[f[0],f[1],f[2]];else if(f.length==3&&f[2]==j)if(undefined!=$("#gis_location_L0 option[value="+f[0]+"]")[0]){$("#gis_location_L0").val(f[0]);m=[f[1]]}else m=[f[0],f[1]];else if(f.length==2&&f[1]==j)if(undefined!=$("#gis_location_L0 option[value="+
f[0]+"]")[0])$("#gis_location_L0").val(f[0]);else m=[f[0]];else{s3_gis_dropdown_select(3,true);$("#gis_location_L4").val(j);$("#"+s3_gis_location_id).val(j);break}}s3_gis_dropdown_select(0,true);if(m[0])if(undefined!=$("#gis_location_L1 option[value="+m[0]+"]")[0])b=m[0];$("#gis_location_L1").val(b);s3_gis_dropdown_select(1,true);if(m[0])if(undefined!=$("#gis_location_L2 option[value="+m[0]+"]")[0])c=m[0];else if(m[1])if(undefined!=$("#gis_location_L2 option[value="+m[1]+"]")[0])c=m[1];$("#gis_location_L2").val(c);
s3_gis_dropdown_select(2,true);if(m[0])if(undefined!=$("#gis_location_L3 option[value="+m[0]+"]")[0])g=m[0];else if(m[1])if(undefined!=$("#gis_location_L3 option[value="+m[1]+"]")[0])g=m[1];else if(m[2])if(undefined!=$("#gis_location_L3 option[value="+m[2]+"]")[0])g=m[2];$("#gis_location_L3").val(g);s3_gis_dropdown_select(3,true);$("#gis_location_L4").val(j);$("#"+s3_gis_location_id).val(j);s3_gis_dropdown_select(4);break;case "L5":break;default:if(f){f=f.split("/");if(f.length==6&&f[5]==j){$("#gis_location_L0").val(f[0]);
b=f[1];c=f[2];g=f[4]}else if(f.length==5&&f[4]==j)if(undefined!=$("#gis_location_L0 option[value="+f[0]+"]")[0]){$("#gis_location_L0").val(f[0]);m=[f[1],f[2],f[3]]}else m=[f[0],f[1],f[2],f[3]];else if(f.length==4&&f[3]==j)if(undefined!=$("#gis_location_L0 option[value="+f[0]+"]")[0]){$("#gis_location_L0").val(f[0]);m=[f[1],f[2]]}else m=[f[0],f[1],f[2]];else if(f.length==3&&f[2]==j)if(undefined!=$("#gis_location_L0 option[value="+f[0]+"]")[0]){$("#gis_location_L0").val(f[0]);m=[f[1]]}else m=[f[0],
f[1]];else if(f.length==2&&f[1]==j)if(undefined!=$("#gis_location_L0 option[value="+f[0]+"]")[0])$("#gis_location_L0").val(f[0]);else m=[f[0]];else{s3_gis_dropdown_select(4,true);$("#gis_location_").val(j);$("#"+s3_gis_location_id).val(j);break}s3_gis_dropdown_select(0,true);if(m[0])if(undefined!=$("#gis_location_L1 option[value="+m[0]+"]")[0])b=m[0];$("#gis_location_L1").val(b);s3_gis_dropdown_select(1,true);if(m[0])if(undefined!=$("#gis_location_L2 option[value="+m[0]+"]")[0])c=m[0];else if(m[1])if(undefined!=
$("#gis_location_L2 option[value="+m[1]+"]")[0])c=m[1];$("#gis_location_L2").val(c);s3_gis_dropdown_select(2,true);if(m[0])if(undefined!=$("#gis_location_L3 option[value="+m[0]+"]")[0])g=m[0];else if(m[1])if(undefined!=$("#gis_location_L3 option[value="+m[1]+"]")[0])g=m[1];else if(m[2])if(undefined!=$("#gis_location_L3 option[value="+m[2]+"]")[0])g=m[2];$("#gis_location_L3").val(g);s3_gis_dropdown_select(3,true);if(m[0])if(undefined!=$("#gis_location_L4 option[value="+m[0]+"]")[0])k=m[0];else if(m[1])if(undefined!=
$("#gis_location_L4 option[value="+m[1]+"]")[0])k=m[1];else if(m[2])if(undefined!=$("#gis_location_L4 option[value="+m[2]+"]")[0])k=m[2];else if(m[3])if(undefined!=$("#gis_location_L4 option[value="+m[4]+"]")[0])k=m[3];$("#gis_location_L4").val(k);s3_gis_dropdown_select(4,true);$("#gis_location_").val(j)}$("#"+s3_gis_location_id).val(j);s3_gis_update_details(j);$("#gis_location_details-btn").removeClass("hidden").show()}return false}}).data("autocomplete")._renderItem=function(h,e){return $("<li></li>").data("item.autocomplete",
e).append("<a>"+e.name+"</a>").appendTo(h)};$("#gis_location_autocomplete").blur(function(){if(!$("#gis_location_autocomplete").val()){$("#"+s3_gis_location_id).val("");a.accept=true}if(a.accept)a.val=$("#gis_location_autocomplete").val();else $("#gis_location_autocomplete").val(a.val);a.accept=false});$("form").submit(function(){S3ClearNavigateAwayConfirm();var h=$("#gis_location_name").val(),e=$("#gis_location_lat").val(),f=$("#gis_location_lon").val(),j=$("#gis_location_addr_street").val(),b=$("#gis_location_postcode").val();
s3_gis_save_location(h,e,f,j,b);return true})}});
