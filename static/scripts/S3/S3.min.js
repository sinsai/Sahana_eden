...
k=f.offset(),m=parseInt(a.curCSS(b,"top",true),10)||0,n=parseInt(a.curCSS(b,"left",true),10)||0;k={top:c.top-k.top+m,left:c.left-k.left+n};"using"in c?c.using.call(b,k):f.css(k)};a.fn.offset=function(b){var c=this[0];if(!c||!c.ownerDocument)return null;if(b)return this.each(function(){a.offset.setOffset(this,b)});return j.call(this)}}})(jQuery);
