...
options+='</option>';}}
selSubField.html(options).val(1).show();href=$('#item_pack_add').attr('href')+"&item_id="+$('[name = "item_id"]').val();$('#item_pack_add').attr('href',href).show();$('#item_pack_ajax_throbber').hide();if(this.attr('name')=='inv_item_id'){InvItemPackIDChange();}}});};var ItemID=$('[name $= "item_id"]').val();if(ItemID==''|ItemID==undefined){$('[id$="item_pack_id__row1"]').hide();$('[id$="item_pack_id__row"]').hide();}else{ItemIDChange();}
