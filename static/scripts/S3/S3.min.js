...
$('.confirmation').click(function(){$(this).fadeOut('slow');return false;});$("input.date").datepicker({changeMonth:true,changeYear:true,dateFormat:'yy-mm-dd',isRTL:false});var togglecallerappend;window.togglecallerappend="True";$('a.colorbox').click(function(){$(this).attr('href',function(){var url_in=$(this).attr('href');var caller=$(this).parents('tr').attr('id').replace(/__row/,'');var url_out=url_in;if(window.togglecallerappend=="True"){url_out=url_out+'&caller='+caller;window.togglecallerappend="False";}
