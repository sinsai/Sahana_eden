...
$('.confirmation').click(function(){$(this).fadeOut('slow');return false;});$('#tooltip').cluetip({activation:'click',splitTitle:'|',closePosition:'bottom'});});