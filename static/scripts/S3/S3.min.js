...
field.focus();};})(jQuery);(function($){$.fn.dataTableSettings=[];$.fn.dataTableExt={};var _oExt=$.fn.dataTableExt;_oExt.sVersion="1.5.b10d";_oExt.iApiIndex=0;_oExt.oApi={};_oExt.afnFiltering=[];_oExt.aoFeatures=[];_oExt.ofnSearch={};_oExt.oPagination={"two_button":{"fnInit":function(oSettings,fnCallbackDraw)
...
nProcessing.innerHTML=oSettings.oLanguage.sProcessing;nProcessing.className="dataTables_processing";nProcessing.style.visibility="hidden";oSettings.nTable.parentNode.insertBefore(nProcessing,oSettings.nTable);return nProcessing;}
