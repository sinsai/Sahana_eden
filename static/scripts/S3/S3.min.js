...
$('.confirmation').click(function(){$(this).fadeOut('slow');return false;});$('input.date').datepicker({changeMonth:true,changeYear:true,dateFormat:'yy-mm-dd',isRTL:false});$('a.colorbox').click(function(){$(this).attr('href',function(){var url_in=$(this).attr('href');var caller='';try{caller=$(this).parents('tr').attr('id').replace(/__row/,'');}catch(e){if(caller=="")return url_in;}
var url_out=url_in;if(url_out.indexOf('&caller=')==-1){url_out=url_out+'&caller='+caller;}
