...
f._range=[];if(typeof e!="number")f._range=e;else for(c=e;c<=m;++c)f._range[f._range.length]=c<10&&m>=10?"0"+c:""+c;Calendar._add_evs(f);return f}var b=g.date.getHours(),e=g.date.getMinutes(),m=!g.time24,f=b>12;m&&f&&(b-=12);var j=a("hour",b,m?1:0,m?12:23),b=Calendar.createElement("span",h);b.innerHTML=":";b.className="colon";var v=a("minute",e,0,59),u=null;h=Calendar.createElement("td",c);h.className="time";h.colSpan=2;m?u=a("ampm",f?"pm":"am",["am","pm"]):h.innerHTML="&nbsp;";g.onSetTime=function(){var a,
c=this.date.getHours(),g=this.date.getMinutes();if(m)(a=c>=12)&&(c-=12),c==0&&(c=12),u.innerHTML=a?"pm":"am";j.innerHTML=c<10?"0"+c:c;v.innerHTML=g<10?"0"+g:g};g.onUpdateTime=function(){var a=this.date,c=parseInt(j.innerHTML,10);m&&(/pm/i.test(u.innerHTML)&&c<12?c+=12:/am/i.test(u.innerHTML)&&c==12&&(c=0));var g=a.getDate(),b=a.getMonth(),e=a.getFullYear();a.setHours(c);a.setMinutes(parseInt(v.innerHTML,10));a.setFullYear(e);a.setMonth(b);a.setDate(g);this.dateClicked=!1;this.callHandler()}}()):this.onSetTime=
...
[],p=Calendar._TT.WEEKEND,n=this.multiple?this.datesCells={}:null,s=0;s<6;++s,j=j.nextSibling){var t=j.firstChild;if(this.weekNumbers)t.className="day wn",t.innerHTML=f.getWeekNumber(),t=t.nextSibling;j.className="daysrow";for(var y=!1,v,u=k[s]=[],r=0;r<7;++r,t=t.nextSibling,f.setDate(v+1)){v=f.getDate();var A=f.getDay();t.className="day";t.pos=s<<4|r;u[r]=t;var x=f.getMonth()==g;if(x)t.otherMonth=!1,y=!0;else if(this.showsOtherMonths)t.className+=" othermonth",t.otherMonth=!0;else{t.className="emptycell";
t.innerHTML="&nbsp;";t.disabled=!0;continue}t.disabled=!1;t.innerHTML=this.getDateText?this.getDateText(f,v):v;n&&(n[f.print("%Y%m%d")]=t);if(this.getDateStatus){var w=this.getDateStatus(f,c,g,v);if(this.getDateToolTip){var H=this.getDateToolTip(f,c,g,v);if(H)t.title=H}if(w===!0)t.className+=" disabled",t.disabled=!0;else{if(/disabled/i.test(w))t.disabled=!0;t.className+=" "+w}}if(!t.disabled){t.caldate=new Date(f);t.ttip="_";if(!this.multiple&&x&&v==m&&this.hiliteToday)t.className+=" selected",this.currentDateEl=
t;f.getFullYear()==e&&f.getMonth()==h&&v==b&&(t.className+=" today",t.ttip+=Calendar._TT.PART_TODAY);p.indexOf(A.toString())!=-1&&(t.className+=t.otherMonth?" oweekend":" weekend")}}if(!y&&!this.showsOtherMonths)j.className="emptyrow"}this.title.innerHTML=Calendar._MN[g]+", "+c;this.onSetTime();this.table.style.visibility="visible";this._initMultipleDates()};
...
0;)for(var j=document.getElementsByTagName(f[--m]),k=null,p=j.length;p>0;){var k=j[--p],e=Calendar.getAbsolutePos(k),n=e.x,s=k.offsetWidth+n,e=e.y,t=k.offsetHeight+e;if(this.hidden||n>c||s<h||e>b||t<g){if(!k.__msh_save_visibility)k.__msh_save_visibility=a(k);k.style.visibility=k.__msh_save_visibility}else{if(!k.__msh_save_visibility)k.__msh_save_visibility=a(k);k.style.visibility="hidden"}}};
...
(function(a,f){function b(c,g){c=c?' id="'+n+c+'"':"";return a("<div"+c+(g?' style="'+g+'"':"")+"/>")}function e(a,c){c=c==="x"?I.width():I.height();return typeof a==="string"?Math.round(/%/.test(a)?c/100*parseInt(a,10):parseInt(a,10)):a}function h(a){return o.photo||/\.(gif|png|jpg|jpeg|bmp)(?:\?([^#]*))?(?:#(\.*))?$/i.test(a)}function c(c){for(var g in c)a.isFunction(c[g])&&g.substring(0,2)!=="on"&&(c[g]=c[g].call(P));c.rel=c.rel||P.rel||"nofollow";c.href=c.href||a(P).attr("href");c.title=c.title||
P.title;return c}function g(c,g){g&&g.call(P);a.event.trigger(c)}function m(){var a,c=n+"Slideshow_",g="click."+n,b,e;o.slideshow&&F[1]&&(b=function(){O.text(o.slideshowStop).unbind(g).bind(y,function(){if(C<F.length-1||o.loop)a=setTimeout(E.next,o.slideshowSpeed)}).bind(t,function(){clearTimeout(a)}).one(g+" "+v,e);z.removeClass(c+"off").addClass(c+"on");a=setTimeout(E.next,o.slideshowSpeed)},e=function(){clearTimeout(a);O.text(o.slideshowStart).unbind([y,t,v,g].join(" ")).one(g,b);z.removeClass(c+
"on").addClass(c+"off")},o.slideshowAuto?b():e())}function j(b){if(!ea){P=b;o=c(a.extend({},a.data(P,p)));F=a(P);C=0;o.rel!=="nofollow"&&(F=a("."+da).filter(function(){return(a.data(this,p).rel||this.rel)===o.rel}),C=F.index(P),C===-1&&(F=F.add(P),C=F.length-1));if(!V){V=ca=!0;z.show();if(o.returnFocus)try{P.blur(),a(P).one(u,function(){try{this.focus()}catch(a){}})}catch(m){}M.css({opacity:+o.opacity,cursor:o.overlayClose?"pointer":"auto"}).show();o.w=e(o.initialWidth,"x");o.h=e(o.initialHeight,
"y");E.position(0);w&&I.bind("resize."+H+" scroll."+H,function(){M.css({width:I.width(),height:I.height(),top:I.scrollTop(),left:I.scrollLeft()})}).trigger("scroll."+H);g(s,o.onOpen);D.add(S).add(Y).add(O).add(T).hide();J.html(o.close).show()}E.load(!0)}}var k={transition:"elastic",speed:300,width:!1,initialWidth:"600",innerWidth:!1,maxWidth:!1,height:!1,initialHeight:"450",innerHeight:!1,maxHeight:!1,scalePhotos:!0,scrolling:!0,inline:!1,html:!1,iframe:!1,photo:!1,href:!1,title:!1,rel:!1,opacity:0.9,
...
7,H=n+"_IE6",M,z,N,Q,W,Z,U,ba,F,I,G,B,K,T,D,O,Y,S,J,L,aa,X,R,P,C,o,V,ca,ea=!1,E,da=n+"Element";E=a.fn[p]=a[p]=function(c,g){var b=this,e;if(!b[0]&&b.selector)return b;c=c||{};if(g)c.onComplete=g;if(!b[0]||b.selector===void 0)b=a("<a/>"),c.open=!0;b.each(function(){a.data(this,p,a.extend({},a.data(this,p)||k,c));a(this).addClass(da)});e=c.open;a.isFunction(e)&&(e=e.call(b));e&&j(b[0]);return b};E.init=function(){I=a(f);z=b().attr({id:p,"class":x?n+"IE":""});M=b("Overlay",w?"position:absolute":"").hide();
N=b("Wrapper");Q=b("Content").append(G=b("LoadedContent","width:0; height:0; overflow:hidden"),K=b("LoadingOverlay").add(b("LoadingGraphic")),T=b("Title"),D=b("Current"),Y=b("Next"),S=b("Previous"),O=b("Slideshow").bind(s,m),J=b("Close"));N.append(b().append(b("TopLeft"),W=b("TopCenter"),b("TopRight")),b(!1,"clear:left").append(Z=b("MiddleLeft"),Q,U=b("MiddleRight")),b(!1,"clear:left").append(b("BottomLeft"),ba=b("BottomCenter"),b("BottomRight"))).children().children().css({"float":"left"});B=b(!1,
...
E.position=function(a,c){function g(a){W[0].style.width=ba[0].style.width=Q[0].style.width=a.style.width;K[0].style.height=K[1].style.height=Q[0].style.height=Z[0].style.height=U[0].style.height=a.style.height}var b,e=Math.max(document.documentElement.clientHeight-o.h-X-L,0)/2+I.scrollTop(),m=Math.max(I.width()-o.w-R-aa,0)/2+I.scrollLeft();b=z.width()===o.w+R&&z.height()===o.h+X?0:a;N[0].style.width=N[0].style.height="9999px";z.dequeue().animate({width:o.w+R,height:o.h+X,top:e,left:m},{duration:b,
complete:function(){g(this);ca=!1;N[0].style.width=o.w+R+aa+"px";N[0].style.height=o.h+X+L+"px";c&&c()},step:function(){g(this)}})};E.resize=function(a){if(V){a=a||{};if(a.width)o.w=e(a.width,"x")-R-aa;if(a.innerWidth)o.w=e(a.innerWidth,"x");G.css({width:o.w});if(a.height)o.h=e(a.height,"y")-X-L;if(a.innerHeight)o.h=e(a.innerHeight,"y");if(!a.innerHeight&&!a.height)a=G.wrapInner("<div style='overflow:auto'></div>").children(),o.h=a.height(),a.replaceWith(a.children());G.css({height:o.h});E.position(o.transition===
"none"?0:o.speed)}};E.prep=function(c){function e(c){var b,j,k,s,r=F.length,t=o.loop;E.position(c,function(){function c(){x&&z[0].style.removeAttribute("filter")}if(V){x&&m&&G.fadeIn(100);G.show();g(A);T.show().html(o.title);if(r>1&&(typeof o.current==="string"&&D.html(o.current.replace(/\{current\}/,C+1).replace(/\{total\}/,r)).show(),Y[t||C<r-1?"show":"hide"]().html(o.next),S[t||C?"show":"hide"]().html(o.previous),b=C?F[C-1]:F[r-1],k=C<r-1?F[C+1]:F[0],o.slideshow&&O.show(),o.preloading)){s=a.data(k,
p).href||k.href;j=a.data(b,p).href||b.href;s=a.isFunction(s)?s.call(k):s;j=a.isFunction(j)?j.call(b):j;if(h(s))a("<img/>")[0].src=s;if(h(j))a("<img/>")[0].src=j}K.hide();o.transition==="fade"?z.fadeTo(f,1,function(){c()}):c();I.bind("resize."+n,function(){E.position(0)});g(y,o.onComplete)}})}if(V){var m,f=o.transition==="none"?0:o.speed;I.unbind("resize."+n);G.remove();G=b("LoadedContent").html(c);G.hide().appendTo(B.show()).css({width:function(){o.w=o.w||G.width();o.w=o.mw&&o.mw<o.w?o.mw:o.w;return o.w}(),
overflow:o.scrolling?"auto":"hidden"}).css({height:function(){o.h=o.h||G.height();o.h=o.mh&&o.mh<o.h?o.mh:o.h;return o.h}()}).prependTo(Q);B.hide();a("#"+n+"Photo").css({cssFloat:"none",marginLeft:"auto",marginRight:"auto"});if(w)a("select").not(z.find("select")).filter(function(){return this.style.visibility!=="hidden"}).css({visibility:"hidden"}).one(v,function(){this.style.visibility="inherit"});o.transition==="fade"?z.fadeTo(f,0,function(){e(0)}):e(f)}};E.load=function(m){var f,j,k,s=E.prep;ca=
!0;P=F[C];m||(o=c(a.extend({},a.data(P,p))));g(r);g(t,o.onLoad);o.h=o.height?e(o.height,"y")-X-L:o.innerHeight&&e(o.innerHeight,"y");o.w=o.width?e(o.width,"x")-R-aa:o.innerWidth&&e(o.innerWidth,"x");o.mw=o.w;o.mh=o.h;if(o.maxWidth)o.mw=e(o.maxWidth,"x")-R-aa,o.mw=o.w&&o.w<o.mw?o.w:o.mw;if(o.maxHeight)o.mh=e(o.maxHeight,"y")-X-L,o.mh=o.h&&o.h<o.mh?o.h:o.mh;f=o.href;K.show();o.inline?(b().hide().insertBefore(a(f)[0]).one(r,function(){a(this).replaceWith(G.children())}),s(a(f))):o.iframe?(z.one(A,function(){var c=
...
o.mw)/j.width,k()),o.mh&&j.height>o.mh&&(c=(j.height-o.mh)/j.height,k()));if(o.h)j.style.marginTop=Math.max(o.h-j.height,0)/2+"px";F[1]&&(C<F.length-1||o.loop)&&a(j).css({cursor:"pointer"}).click(E.next);if(x)j.style.msInterpolationMode="bicubic";setTimeout(function(){s(j)},1)},setTimeout(function(){j.src=f},1)):f&&B.load(f,function(c,g,b){s(g==="error"?"Request unsuccessful: "+b.statusText:a(this).children())})};E.next=function(){ca||(C=C<F.length-1?C+1:0,E.load())};E.prev=function(){ca||(C=C?C-
1:F.length-1,E.load())};E.close=function(){V&&!ea&&(ea=!0,V=!1,g(v,o.onCleanup),I.unbind("."+n+" ."+H),M.fadeTo("fast",0),z.stop().fadeTo("fast",0,function(){g(r);G.remove();z.add(M).css({opacity:1,cursor:"auto"}).hide();setTimeout(function(){ea=!1;g(u,o.onClosed)},1)}))};E.element=function(){return a(P)};E.settings=k;a(E.init)})(jQuery,this);
(function(a,f){function b(){this.debug=!0;this._curInst=null;this._isInline=!1;this._disabledInputs=[];this._inDialog=this._timepickerShowing=!1;this._dialogClass="ui-timepicker-dialog";this._mainDivId="ui-timepicker-div";this._inlineClass="ui-timepicker-inline";this._currentClass="ui-timepicker-current";this._dayOverClass="ui-timepicker-days-cell-over";this.regional=[];this.regional[""]={hourText:"Hour",minuteText:"Minute",amPmText:["AM","PM"]};this._defaults={showOn:"focus",button:null,showAnim:"fadeIn",
showOptions:{},appendText:"",onSelect:null,onClose:null,timeSeparator:":",showPeriod:!1,showPeriodLabels:!0,showLeadingZero:!0,showMinutesLeadingZero:!0,altField:"",defaultTime:"",onHourShow:null,onMinuteShow:null,zIndex:null};a.extend(this._defaults,this.regional[""]);this.tpDiv=a('<div id="'+this._mainDivId+'" class="ui-timepicker ui-widget ui-helper-clearfix ui-corner-all " style="display: none"></div>')}function e(c,g){a.extend(c,g);for(var b in g)if(g[b]==null||g[b]==f)c[b]=g[b];return c}a.extend(a.ui,
{timepicker:{version:"0.1.3"}});var h=(new Date).getTime();a.extend(b.prototype,{markerClassName:"hasTimepicker",log:function(){this.debug&&console.log.apply("",arguments)},_widgetTimepicker:function(){return this.tpDiv},setDefaults:function(a){e(this._defaults,a||{});return this},_attachTimepicker:function(c,g){var b=null,e;for(e in this._defaults){var f=c.getAttribute("time:"+e);if(f){b=b||{};try{b[e]=eval(f)}catch(h){b[e]=f}}}e=c.nodeName.toLowerCase();f=e=="div"||e=="span";if(!c.id)this.uuid+=
1,c.id="tp"+this.uuid;var n=this._newInst(a(c),f);n.settings=a.extend({},g||{},b||{});e=="input"?this._connectTimepicker(c,n):f&&this._inlineTimepicker(c,n)},_newInst:function(c,g){return{id:c[0].id.replace(/([^A-Za-z0-9_-])/g,"\\\\$1"),input:c,selectedDay:0,selectedMonth:0,selectedYear:0,drawMonth:0,drawYear:0,inline:g,tpDiv:!g?this.tpDiv:a('<div class="'+this._inlineClass+' ui-timepicker ui-widget  ui-helper-clearfix"></div>')}},_connectTimepicker:function(c,g){var b=a(c);g.append=a([]);g.trigger=
a([]);b.hasClass(this.markerClassName)||(this._attachments(b,g),b.addClass(this.markerClassName).keydown(this._doKeyDown).keyup(this._doKeyUp).bind("setData.timepicker",function(a,c,b){g.settings[c]=b}).bind("getData.timepicker",function(a,c){return this._get(g,c)}),a.data(c,"timepicker",g))},_doKeyDown:function(c){var g=!0;a.timepicker._getInst(c.target)._keyEvent=!0;if(a.timepicker._timepickerShowing)switch(c.keyCode){case 9:a.timepicker._hideTimepicker();g=!1;break;case 27:a.timepicker._hideTimepicker();
break;default:g=!1}else c.keyCode==36&&c.ctrlKey?a.timepicker._showTimepicker(this):g=!1;g&&(c.preventDefault(),c.stopPropagation())},_doKeyUp:function(c){c=a.timepicker._getInst(c.target);a.timepicker._setTimeFromField(c);a.timepicker._updateTimepicker(c)},_attachments:function(c,g){var b=this._get(g,"appendText"),e=this._get(g,"isRTL");g.append&&g.append.remove();if(b)g.append=a('<span class="'+this._appendClass+'">'+b+"</span>"),c[e?"before":"after"](g.append);c.unbind("focus",this._showTimepicker);
g.trigger&&g.trigger.remove();b=this._get(g,"showOn");(b=="focus"||b=="both")&&c.focus(this._showTimepicker);if(b=="button"||b=="both")b=this._get(g,"button"),a(b).click(function(){a.timepicker._timepickerShowing&&a.timepicker._lastInput==c[0]?a.timepicker._hideTimepicker():a.timepicker._showTimepicker(c[0]);return!1})},_inlineTimepicker:function(c,g){var b=a(c);b.hasClass(this.markerClassName)||(b.addClass(this.markerClassName).append(g.tpDiv).bind("setData.timepicker",function(a,c,b){g.settings[c]=
b}).bind("getData.timepicker",function(a,c){return this._get(g,c)}),a.data(c,"timepicker",g),this._setTimeFromField(g),this._updateTimepicker(g),g.tpDiv.show())},_showTimepicker:function(c){c=c.target||c;c.nodeName.toLowerCase()!="input"&&(c=a("input",c.parentNode)[0]);if(!(a.timepicker._isDisabledTimepicker(c)||a.timepicker._lastInput==c)){a.timepicker._hideTimepicker();var g=a.timepicker._getInst(c);a.timepicker._curInst&&a.timepicker._curInst!=g&&a.timepicker._curInst.tpDiv.stop(!0,!0);var b=a.timepicker._get(g,
"beforeShow");e(g.settings,b?b.apply(c,[c,g]):{});g.lastVal=null;a.timepicker._lastInput=c;a.timepicker._setTimeFromField(g);if(a.timepicker._inDialog)c.value="";if(!a.timepicker._pos)a.timepicker._pos=a.timepicker._findPos(c),a.timepicker._pos[1]+=c.offsetHeight;var f=!1;a(c).parents().each(function(){f|=a(this).css("position")=="fixed";return!f});f&&a.browser.opera&&(a.timepicker._pos[0]-=document.documentElement.scrollLeft,a.timepicker._pos[1]-=document.documentElement.scrollTop);b={left:a.timepicker._pos[0],
top:a.timepicker._pos[1]};a.timepicker._pos=null;g.tpDiv.css({position:"absolute",display:"block",top:"-1000px"});a.timepicker._updateTimepicker(g);g._hoursClicked=!1;g._minutesClicked=!1;b=a.timepicker._checkOffset(g,b,f);g.tpDiv.css({position:a.timepicker._inDialog&&a.blockUI?"static":f?"fixed":"absolute",display:"none",left:b.left+"px",top:b.top+"px"});if(!g.inline){var b=a.timepicker._get(g,"showAnim"),h=a.timepicker._get(g,"duration"),p=a.timepicker._get(g,"zIndex"),n=function(){a.timepicker._timepickerShowing=
!0;var c=a.timepicker._getBorders(g.tpDiv);g.tpDiv.find("iframe.ui-timepicker-cover").css({left:-c[0],top:-c[1],width:g.tpDiv.outerWidth(),height:g.tpDiv.outerHeight()})};p||(p=a(c).zIndex()+1);g.tpDiv.zIndex(p);if(a.effects&&a.effects[b])g.tpDiv.show(b,a.timepicker._get(g,"showOptions"),h,n);else g.tpDiv[b||"show"](b?h:null,n);(!b||!h)&&n();g.input.is(":visible")&&!g.input.is(":disabled")&&g.input.focus();a.timepicker._curInst=g}}},_updateTimepicker:function(c){var g=this,b=a.timepicker._getBorders(c.tpDiv);
c.tpDiv.empty().append(this._generateHTML(c)).find("iframe.ui-timepicker-cover").css({left:-b[0],top:-b[1],width:c.tpDiv.outerWidth(),height:c.tpDiv.outerHeight()}).end().find(".ui-timepicker-minute-cell").bind("click",{fromDoubleClick:!1},a.proxy(a.timepicker.selectMinutes,this)).bind("dblclick",{fromDoubleClick:!0},a.proxy(a.timepicker.selectMinutes,this)).end().find(".ui-timepicker-hour-cell").bind("click",{fromDoubleClick:!1},a.proxy(a.timepicker.selectHours,this)).bind("dblclick",{fromDoubleClick:!0},
a.proxy(a.timepicker.selectHours,this)).end().find(".ui-timepicker td a").bind("mouseout",function(){a(this).removeClass("ui-state-hover");this.className.indexOf("ui-timepicker-prev")!=-1&&a(this).removeClass("ui-timepicker-prev-hover");this.className.indexOf("ui-timepicker-next")!=-1&&a(this).removeClass("ui-timepicker-next-hover")}).bind("mouseover",function(){if(!g._isDisabledTimepicker(c.inline?c.tpDiv.parent()[0]:c.input[0]))a(this).parents(".ui-timepicker-calendar").find("a").removeClass("ui-state-hover"),
a(this).addClass("ui-state-hover"),this.className.indexOf("ui-timepicker-prev")!=-1&&a(this).addClass("ui-timepicker-prev-hover"),this.className.indexOf("ui-timepicker-next")!=-1&&a(this).addClass("ui-timepicker-next-hover")}).end().find("."+this._dayOverClass+" a").trigger("mouseover").end()},_generateHTML:function(a){var g,b="",e=this._get(a,"showPeriod")==!0,f=this._get(a,"showPeriodLabels")==!0,h=this._get(a,"showLeadingZero")==!0,n=this._get(a,"amPmText"),b='<table class="ui-timepicker-table ui-widget-content ui-corner-all"><tr><td class="ui-timepicker-hours"><div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+
this._get(a,"hourText")+'</div><table class="ui-timepicker">';b+="<tr>"+(f?'<th rowspan="2" class="periods">'+n[0]+"</th>":"");for(g=0;g<=5;g++)b+=this._generateHTMLHourCell(a,g,e,h);b+="</tr><tr>";for(g=6;g<=11;g++)b+=this._generateHTMLHourCell(a,g,e,h);b+="</tr><tr>"+(f?'<th rowspan="2" class="periods">'+n[1]+"</th>":"");for(g=12;g<=17;g++)b+=this._generateHTMLHourCell(a,g,e,h);b+="</tr><tr>";for(g=18;g<=23;g++)b+=this._generateHTMLHourCell(a,g,e,h);b+='</tr></table></td><td class="ui-timepicker-minutes">';
b+=this._generateHTMLMinutes(a);b+="</td></tr></table>";return b},_updateMinuteDisplay:function(c){var g=this._generateHTMLMinutes(c);c.tpDiv.find("td.ui-timepicker-minutes").html(g).find(".ui-timepicker-minute-cell").bind("click",{fromDoubleClick:!1},a.proxy(a.timepicker.selectMinutes,this)).bind("dblclick",{fromDoubleClick:!0},a.proxy(a.timepicker.selectMinutes,this))},_generateHTMLMinutes:function(a){var g,b=this._get(a,"showMinutesLeadingZero")==!0,e=this._get(a,"onMinuteShow");if(e&&e.apply(a.input?
a.input[0]:null,[a.hours,a.minutes])==!1)for(g=0;g<60;g+=5)if(e.apply(a.input?a.input[0]:null,[a.hours,g])){a.minutes=g;break}e='<div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+this._get(a,"minuteText")+'</div><table class="ui-timepicker"><tr>';for(g=0;g<15;g+=5)e+=this._generateHTMLMinuteCell(a,g,g<10&&b?"0"+g.toString():g.toString());e+="</tr><tr>";for(g=15;g<30;g+=5)e+=this._generateHTMLMinuteCell(a,g,g.toString());e+="</tr><tr>";for(g=30;g<45;g+=5)e+=this._generateHTMLMinuteCell(a,
g,g.toString());e+="</tr><tr>";for(g=45;g<60;g+=5)e+=this._generateHTMLMinuteCell(a,g,g.toString());e+="</tr></table>";return e},_generateHTMLHourCell:function(a,g,b,e){var f=g;g>12&&b&&(f=g-12);f==0&&b&&(f=12);f<10&&e&&(f="0"+f);b="";b=!0;(e=this._get(a,"onHourShow"))&&(b=e.apply(a.input?a.input[0]:null,[g]));return b=b?'<td class="ui-timepicker-hour-cell" data-timepicker-instance-id="#'+a.id.replace("\\\\","\\")+'" data-hour="'+g.toString()+'"><a href="#timepick" class="ui-state-default '+(g==a.hours?
"ui-state-active":"")+'">'+f.toString()+"</a></td>":'<td><span class="ui-state-default ui-state-disabled '+(g==a.hours?" ui-state-active ":" ")+'">'+f.toString()+"</span></td>"},_generateHTMLMinuteCell:function(a,g,b){var e="",e=!0,f=this._get(a,"onMinuteShow");f&&(e=f.apply(a.input?a.input[0]:null,[a.hours,g]));return e=e?'<td class="ui-timepicker-minute-cell" data-timepicker-instance-id="#'+a.id.replace("\\\\","\\")+'" data-minute="'+g.toString()+'" ><a href="#timepick" class="ui-state-default '+
(g==a.minutes?"ui-state-active":"")+'" >'+b+"</a></td>":'<td><span class="ui-state-default ui-state-disabled" >'+b+"</span></td>"},_isDisabledTimepicker:function(a){if(!a)return!1;for(var g=0;g<this._disabledInputs.length;g++)if(this._disabledInputs[g]==a)return!0;return!1},_checkOffset:function(c,g,b){var e=c.tpDiv.outerWidth(),f=c.tpDiv.outerHeight(),h=c.input?c.input.outerWidth():0,n=c.input?c.input.outerHeight():0,s=document.documentElement.clientWidth+a(document).scrollLeft(),t=document.documentElement.clientHeight+
a(document).scrollTop();g.left-=this._get(c,"isRTL")?e-h:0;g.left-=b&&g.left==c.input.offset().left?a(document).scrollLeft():0;g.top-=b&&g.top==c.input.offset().top+n?a(document).scrollTop():0;g.left-=Math.min(g.left,g.left+e>s&&s>e?Math.abs(g.left+e-s):0);g.top-=Math.min(g.top,g.top+f>t&&t>f?Math.abs(f+n):0);return g},_findPos:function(c){for(var g=this._get(this._getInst(c),"isRTL");c&&(c.type=="hidden"||c.nodeType!=1);)c=c[g?"previousSibling":"nextSibling"];c=a(c).offset();return[c.left,c.top]},
...
!1;this._lastInput=null;this._inDialog&&(this._dialogInput.css({position:"absolute",left:"0",top:"-100px"}),a.blockUI&&(a.unblockUI(),a("body").append(this.tpDiv)));this._inDialog=!1}},_tidyDialog:function(a){a.tpDiv.removeClass(this._dialogClass).unbind(".ui-timepicker")},_getInst:function(c){try{return a.data(c,"timepicker")}catch(g){throw"Missing instance data for this timepicker";}},_get:function(a,g){return a.settings[g]!==f?a.settings[g]:this._defaults[g]},_setTimeFromField:function(c){if(c.input.val()!=
c.lastVal){var g=this._get(c,"defaultTime"),b=this._getCurrentTimeRounded(c);g!=""&&(b=g);c.inline==!1&&c.input.val()!=""&&(b=c.input.val());g=c.lastVal=b;g=this.parseTime(c,g);c.hours=g.hours;c.minutes=g.minutes;a.timepicker._updateTimepicker(c)}},_setTimeTimepicker:function(a,g){var b=this._getInst(a);b&&(this._setTime(b,g),this._updateTimepicker(b),this._updateAlternate(b))},_setTime:function(a,g,b){var e=a.hours,f=a.minutes,g=this.parseTime(a,g);a.hours=g.hours;a.minutes=g.minutes;(e!=a.hours||
f!=a.minuts)&&!b&&a.input.trigger("change");this._updateTimepicker(a);this._updateSelectedValue(a)},_getCurrentTimeRounded:function(a){var g=new Date,a=this._get(a,"timeSeparator"),b=g.getMinutes(),b=Math.round(b/5)*5;return g.getHours().toString()+a+b.toString()},parseTime:function(a,g){var b={hours:-1,minutes:-1},e=this._get(a,"timeSeparator"),f=this._get(a,"amPmText"),e=g.indexOf(e);if(e==-1)return b;b.hours=parseInt(g.substr(0,e),10);b.minutes=parseInt(g.substr(e+1),10);var e=this._get(a,"showPeriod")==
!0,h=g.toUpperCase();b.hours<12&&e&&h.indexOf(f[1].toUpperCase())!=-1&&(b.hours+=12);if(b.hours==12&&e&&h.indexOf(f[0].toUpperCase())!=-1)b.hours=0;return b},selectHours:function(c){var g=a(c.currentTarget),b=g.attr("data-timepicker-instance-id"),e=g.attr("data-hour"),c=c.data.fromDoubleClick,b=this._getInst(a(b)[0]);g.parents(".ui-timepicker-hours:first").find("a").removeClass("ui-state-active");g.children("a").addClass("ui-state-active");b.hours=e;this._updateSelectedValue(b);b._hoursClicked=!0;
if(b._minutesClicked||c)return a.timepicker._hideTimepicker(),!1;this._get(b,"onMinuteShow")&&this._updateMinuteDisplay(b);return!1},selectMinutes:function(c){var g=a(c.currentTarget),b=g.attr("data-timepicker-instance-id"),e=g.attr("data-minute"),c=c.data.fromDoubleClick,b=this._getInst(a(b)[0]);g.parents(".ui-timepicker-minutes:first").find("a").removeClass("ui-state-active");g.children("a").addClass("ui-state-active");b.minutes=e;this._updateSelectedValue(b);b._minutesClicked=!0;(b._hoursClicked||
c)&&a.timepicker._hideTimepicker();return!1},_updateSelectedValue:function(a){if(a.hours<0||a.hours>23)a.hours=12;if(a.minutes<0||a.minutes>59)a.minutes=0;var g="",b=this._get(a,"showPeriod")==!0,e=this._get(a,"showLeadingZero")==!0,f=this._get(a,"amPmText"),h=a.minutes?a.minutes:0,n=a.hours?a.hours:0;n||(displayHoyrs=0);b&&(a.hours==0&&(n=12),a.hours<12?g=f[0]:(g=f[1],n>12&&(n-=12)));b=n.toString();e&&n<10&&(b="0"+b);e=h.toString();h<10&&(e="0"+e);h=b+this._get(a,"timeSeparator")+e;g.length>0&&(h+=
" "+g);a.input&&(a.input.val(h),a.input.trigger("change"));(g=this._get(a,"onSelect"))&&g.apply(a.input?a.input[0]:null,[h,a]);this._updateAlternate(a,h);return h},_updateAlternate:function(c,g){var b=this._get(c,"altField");b&&a(b).each(function(){a(this).val(g)})}});a.fn.timepicker=function(c){if(!a.timepicker.initialized)a(document).mousedown(a.timepicker._checkExternalClick).find("body").append(a.timepicker.tpDiv),a.timepicker.initialized=!0;var g=Array.prototype.slice.call(arguments,1);if(typeof c==
"string"&&(c=="isDisabled"||c=="getTime"||c=="widget"))return a.timepicker["_"+c+"Timepicker"].apply(a.timepicker,[this[0]].concat(g));if(c=="option"&&arguments.length==2&&typeof arguments[1]=="string")return a.timepicker["_"+c+"Timepicker"].apply(a.timepicker,[this[0]].concat(g));return this.each(function(){typeof c=="string"?a.timepicker["_"+c+"Timepicker"].apply(a.timepicker,[this].concat(g)):a.timepicker._attachTimepicker(this,c)})};a.timepicker=new b;a.timepicker.initialized=!1;a.timepicker.uuid=
(new Date).getTime();a.timepicker.version="0.1.3";window["TP_jQuery_"+h]=a})(jQuery);
...
f=a("#cluetip").css({position:"absolute"}),e=a("#cluetip-outer").css({position:"relative",zIndex:x}),b=a("#cluetip-inner"),h=a("#cluetip-title"),c=a("#cluetip-arrows"),g=a('<div id="cluetip-waitimage"></div>').css({position:"absolute"}).insertBefore(f).hide());var M=r.dropShadow?+r.dropShadowSteps:0;if(!m){m=a([]);for(var z=0;z<M;z++)m=m.add(a("<div></div>").css({zIndex:x-1,opacity:0.1,top:1+z,left:1+z}));m.css({position:"absolute",backgroundColor:"#000"}).prependTo(f)}var N=u.attr(r.attribute),Q=
r.cluetipClass;if(!N&&!r.splitTitle&&!n)return!0;r.local&&r.localPrefix&&(N=r.localPrefix+N);r.local&&r.hideLocal&&a(N+":first").hide();var W=parseInt(r.topOffset,10),Z=parseInt(r.leftOffset,10),U,ba,F=isNaN(parseInt(r.height,10))?"auto":/\D/g.test(r.height)?r.height:r.height+"px",I,G,B,K,T,D=parseInt(r.width,10)||275,O=D+(parseInt(f.css("paddingLeft"),10)||0)+(parseInt(f.css("paddingRight"),10)||0)+M,Y=this.offsetWidth,S,J,L,aa,X,R=r.attribute!="title"?u.attr(r.titleAttribute):"";r.splitTitle&&(R==
void 0&&(R=""),X=R.split(r.splitTitle),R=X.shift());r.escapeTitle&&(R=R.replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;"));var P=function(h){if(!r.onActivate(u))return!1;w=!0;f.removeClass().css({width:D});N==u.attr("href")&&u.css("cursor",r.cursor);r.hoverClass&&u.addClass(r.hoverClass);G=u.offset().top;S=u.offset().left;L=h.pageX;K=h.pageY;v.tagName.toLowerCase()!="area"&&(I=a(document).scrollTop(),aa=a(window).width());if(r.positionBy=="fixed")J=Y+S+Z,f.css({left:J});else{J=Y>S&&
S>O||S+Y+O+Z>aa?S-O-Z:Y+S+Z;if(v.tagName.toLowerCase()=="area"||r.positionBy=="mouse"||Y+O>aa)L+20+O>aa?(f.addClass(" cluetip-"+Q),J=L-O-Z>=0?L-O-Z-parseInt(f.css("marginLeft"),10)+parseInt(b.css("marginRight"),10):L-O/2):J=L+Z;var m=J<0?h.pageY+W:h.pageY;f.css({left:J>0&&r.positionBy!="bottomTop"?J:L+O/2>aa?aa/2-O/2:Math.max(L-O/2,0),zIndex:u.data("thisInfo").zIndex});c.css({zIndex:u.data("thisInfo").zIndex+1})}ba=a(window).height();if(n)typeof n=="function"&&(n=n.call(v)),b.html(n),C(m);else if(X){h=
X.length;b.html(h?X[0]:"");if(h>1)for(var k=1;k<h;k++)b.append('<div class="split-body">'+X[k]+"</div>");C(m)}else if(!r.local&&N.indexOf("#")!==0)if(/\.(jpe?g|tiff?|gif|png)$/i.test(N))b.html('<img src="'+N+'" alt="'+R+'" />'),C(m);else if(A&&r.ajaxCache)b.html(A),C(m);else{var p=r.ajaxSettings.beforeSend,s=r.ajaxSettings.error,o=r.ajaxSettings.success,y=r.ajaxSettings.complete,h=a.extend(!0,{},r.ajaxSettings,{cache:!1,url:N,beforeSend:function(a){p&&p.call(v,a,f,b);e.children().empty();r.waitImage&&
g.css({top:K+20,left:L+20,zIndex:u.data("thisInfo").zIndex-1}).show()},error:function(a,c){w&&(s?s.call(v,a,c,f,b):b.html("<i>sorry, the contents could not be loaded</i>"))},success:function(a,c){A=r.ajaxProcess.call(v,a);w&&(o&&o.call(v,a,c,f,b),b.html(A))},complete:function(c,e){y&&y.call(v,c,e,f,b);var h=b[0].getElementsByTagName("img");j=h.length;for(var k=0,n=h.length;k<n;k++)h[k].complete&&j--;j&&!a.browser.opera?a(h).bind("load error",function(){j--;j<1&&(g.hide(),w&&C(m))}):(g.hide(),w&&C(m))}});
a.ajax(h)}else r.local&&(h=a(N+(/#\S+$/.test(N)?"":":eq("+t+")")).clone(!0).show(),b.html(h),C(m))},C=function(g){f.addClass("cluetip-"+Q);if(r.truncate){var j=b.text().slice(0,r.truncate)+"...";b.html(j)}R?h.show().html(R):r.showTitle?h.show().html("&nbsp;"):h.hide();r.sticky&&(j=a('<div id="cluetip-close"><a href="#">'+r.closeText+"</a></div>"),r.closePosition=="bottom"?j.appendTo(b):r.closePosition=="title"?j.prependTo(h):j.prependTo(b),j.bind("click.cluetip",function(){V();return!1}),r.mouseOutClose?
f.bind("mouseleave.cluetip",function(){V()}):f.unbind("mouseleave.cluetip"));j="";e.css({zIndex:u.data("thisInfo").zIndex,overflow:F=="auto"?"visible":"auto",height:F});U=F=="auto"?Math.max(f.outerHeight(),f.height()):parseInt(F,10);B=G;T=I+ba;r.positionBy=="fixed"?B=G-r.dropShadowSteps+W:J<L&&Math.max(J,0)+O>L||r.positionBy=="bottomTop"?G+U+W>T&&K-I>U+W?(B=K-U-W,j="top"):(B=K+W,j="bottom"):B=G+U+W>T?U>=ba?I:T-U-W:u.css("display")=="block"||v.tagName.toLowerCase()=="area"||r.positionBy=="mouse"?g-
W:G-r.dropShadowSteps;j==""&&(J<S?j="left":j="right");f.css({top:B+"px"}).removeClass().addClass("clue-"+j+"-"+Q).addClass(" cluetip-"+Q);r.arrows?(g=G-B-r.dropShadowSteps,c.css({top:/(left|right)/.test(j)&&J>=0&&g>0?g+"px":/(left|right)/.test(j)?0:""}).show()):c.hide();m.hide();f.hide()[r.fx.open](r.fx.openSpeed||0);r.dropShadow&&m.css({height:U,width:D,zIndex:u.data("thisInfo").zIndex-1}).show();a.fn.bgiframe&&f.bgiframe();r.delayedClose>0&&(H=setTimeout(V,r.delayedClose));r.onShow.call(v,f,b)},
o=function(){w=!1;g.hide();if(!r.sticky||/click|toggle/.test(r.activation))V(),clearTimeout(H);r.hoverClass&&u.removeClass(r.hoverClass)},V=function(){e.parent().hide().removeClass();r.onHide.call(v,f,b);u.removeClass("cluetip-clicked");R&&u.attr(r.titleAttribute,R);u.css("cursor","");r.arrows&&c.css({top:""})};a(document).bind("hideCluetip",function(){V()});if(/click|toggle/.test(r.activation))u.bind("click.cluetip",function(c){f.is(":hidden")||!u.is(".cluetip-clicked")?(P(c),a(".cluetip-clicked").removeClass("cluetip-clicked"),
u.addClass("cluetip-clicked")):o(c);this.blur();return!1});else if(r.activation=="focus")u.bind("focus.cluetip",function(a){P(a)}),u.bind("blur.cluetip",function(a){o(a)});else{u[r.clickThrough?"unbind":"bind"]("click",y);var ca=function(a){if(r.tracking==!0){var c=J-a.pageX,g=B?B-a.pageY:G-a.pageY;u.bind("mousemove.cluetip",function(a){f.css({left:a.pageX+c,top:a.pageY+g})})}};a.fn.hoverIntent&&r.hoverIntent?u.hoverIntent({sensitivity:r.hoverIntent.sensitivity,interval:r.hoverIntent.interval,over:function(a){P(a);
...
b.match(/MM/)?"monthNames":"monthNamesShort")));g.setDate(e(this._get(a,b.match(/DD/)?"dayNames":"dayNamesShort"))+20-g.getDay())}a.input.attr("size",this._formatDate(a,g).length)}},_inlineDatepicker:function(c,g){var b=a(c);b.hasClass(this.markerClassName)||(b.addClass(this.markerClassName).append(g.dpDiv).bind("setData.datepicker",function(a,c,b){g.settings[c]=b}).bind("getData.datepicker",function(a,c){return this._get(g,c)}),a.data(c,"datepicker",g),this._setDate(g,this._getDefaultDate(g),!0),
this._updateDatepicker(g),this._updateAlternate(g),g.dpDiv.show())},_dialogDatepicker:function(c,g,b,f,h){c=this._dialogInst;if(!c)this.uuid+=1,this._dialogInput=a('<input type="text" id="dp'+this.uuid+'" style="position: absolute; top: -100px; width: 0px; z-index: -10;"/>'),this._dialogInput.keydown(this._doKeyDown),a("body").append(this._dialogInput),c=this._dialogInst=this._newInst(this._dialogInput,!1),c.settings={},a.data(this._dialogInput[0],"datepicker",c);e(c.settings,f||{});g=g&&g.constructor==
Date?this._formatDate(c,g):g;this._dialogInput.val(g);this._pos=h?h.length?h:[h.pageX,h.pageY]:null;if(!this._pos)this._pos=[document.documentElement.clientWidth/2-100+(document.documentElement.scrollLeft||document.body.scrollLeft),document.documentElement.clientHeight/2-150+(document.documentElement.scrollTop||document.body.scrollTop)];this._dialogInput.css("left",this._pos[0]+20+"px").css("top",this._pos[1]+"px");c.settings.onSelect=b;this._inDialog=!0;this.dpDiv.addClass(this._dialogClass);this._showDatepicker(this._dialogInput[0]);
a.blockUI&&a.blockUI(this.dpDiv);a.data(this._dialogInput[0],"datepicker",c);return this},_destroyDatepicker:function(c){var g=a(c),b=a.data(c,"datepicker");if(g.hasClass(this.markerClassName)){var e=c.nodeName.toLowerCase();a.removeData(c,"datepicker");e=="input"?(b.append.remove(),b.trigger.remove(),g.removeClass(this.markerClassName).unbind("focus",this._showDatepicker).unbind("keydown",this._doKeyDown).unbind("keypress",this._doKeyPress).unbind("keyup",this._doKeyUp)):(e=="div"||e=="span")&&g.removeClass(this.markerClassName).empty()}},
_enableDatepicker:function(c){var g=a(c),b=a.data(c,"datepicker");if(g.hasClass(this.markerClassName)){var e=c.nodeName.toLowerCase();e=="input"?(c.disabled=!1,b.trigger.filter("button").each(function(){this.disabled=!1}).end().filter("img").css({opacity:"1.0",cursor:""})):(e=="div"||e=="span")&&g.children("."+this._inlineClass).children().removeClass("ui-state-disabled");this._disabledInputs=a.map(this._disabledInputs,function(a){return a==c?null:a})}},_disableDatepicker:function(c){var g=a(c),b=
a.data(c,"datepicker");if(g.hasClass(this.markerClassName)){var e=c.nodeName.toLowerCase();e=="input"?(c.disabled=!0,b.trigger.filter("button").each(function(){this.disabled=!0}).end().filter("img").css({opacity:"0.5",cursor:"default"})):(e=="div"||e=="span")&&g.children("."+this._inlineClass).children().addClass("ui-state-disabled");this._disabledInputs=a.map(this._disabledInputs,function(a){return a==c?null:a});this._disabledInputs[this._disabledInputs.length]=c}},_isDisabledDatepicker:function(a){if(!a)return!1;
for(var g=0;g<this._disabledInputs.length;g++)if(this._disabledInputs[g]==a)return!0;return!1},_getInst:function(c){try{return a.data(c,"datepicker")}catch(g){throw"Missing instance data for this datepicker";}},_optionDatepicker:function(c,g,b){var h=this._getInst(c);if(arguments.length==2&&typeof g=="string")return g=="defaults"?a.extend({},a.datepicker._defaults):h?g=="all"?a.extend({},h.settings):this._get(h,g):null;var k=g||{};typeof g=="string"&&(k={},k[g]=b);if(h){this._curInst==h&&this._hideDatepicker();
var p=this._getDateDatepicker(c,!0),n=this._getMinMaxDate(h,"min"),s=this._getMinMaxDate(h,"max");e(h.settings,k);if(n!==null&&k.dateFormat!==f&&k.minDate===f)h.settings.minDate=this._formatDate(h,n);if(s!==null&&k.dateFormat!==f&&k.maxDate===f)h.settings.maxDate=this._formatDate(h,s);this._attachments(a(c),h);this._autoSize(h);this._setDateDatepicker(c,p);this._updateDatepicker(h)}},_changeDatepicker:function(a,g,b){this._optionDatepicker(a,g,b)},_refreshDatepicker:function(a){(a=this._getInst(a))&&
this._updateDatepicker(a)},_setDateDatepicker:function(a,g){var b=this._getInst(a);b&&(this._setDate(b,g),this._updateDatepicker(b),this._updateAlternate(b))},_getDateDatepicker:function(a,g){var b=this._getInst(a);b&&!b.inline&&this._setDateFromField(b,g);return b?this._getDate(b):null},_doKeyDown:function(c){var g=a.datepicker._getInst(c.target),b=!0,e=g.dpDiv.is(".ui-datepicker-rtl");g._keyEvent=!0;if(a.datepicker._datepickerShowing)switch(c.keyCode){case 9:a.datepicker._hideDatepicker();b=!1;
break;case 13:return b=a("td."+a.datepicker._dayOverClass+":not(."+a.datepicker._currentClass+")",g.dpDiv),b[0]?a.datepicker._selectDay(c.target,g.selectedMonth,g.selectedYear,b[0]):a.datepicker._hideDatepicker(),!1;case 27:a.datepicker._hideDatepicker();break;case 33:a.datepicker._adjustDate(c.target,c.ctrlKey?-a.datepicker._get(g,"stepBigMonths"):-a.datepicker._get(g,"stepMonths"),"M");break;case 34:a.datepicker._adjustDate(c.target,c.ctrlKey?+a.datepicker._get(g,"stepBigMonths"):+a.datepicker._get(g,
...
a(this).addClass("ui-state-hover"),this.className.indexOf("ui-datepicker-prev")!=-1&&a(this).addClass("ui-datepicker-prev-hover"),this.className.indexOf("ui-datepicker-next")!=-1&&a(this).addClass("ui-datepicker-next-hover")}).end().find("."+this._dayOverClass+" a").trigger("mouseover").end();e=this._getNumberOfMonths(c);f=e[1];f>1?c.dpDiv.addClass("ui-datepicker-multi-"+f).css("width",17*f+"em"):c.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");c.dpDiv[(e[0]!=
1||e[1]!=1?"add":"remove")+"Class"]("ui-datepicker-multi");c.dpDiv[(this._get(c,"isRTL")?"add":"remove")+"Class"]("ui-datepicker-rtl");c==a.datepicker._curInst&&a.datepicker._datepickerShowing&&c.input&&c.input.is(":visible")&&!c.input.is(":disabled")&&c.input[0]!=document.activeElement&&c.input.focus();if(c.yearshtml){var h=c.yearshtml;setTimeout(function(){h===c.yearshtml&&c.dpDiv.find("select.ui-datepicker-year:first").replaceWith(c.yearshtml);h=c.yearshtml=null},0)}},_getBorders:function(a){var b=
function(a){return{thin:1,medium:2,thick:3}[a]||a};return[parseFloat(b(a.css("border-left-width"))),parseFloat(b(a.css("border-top-width")))]},_checkOffset:function(c,b,e){var f=c.dpDiv.outerWidth(),h=c.dpDiv.outerHeight(),p=c.input?c.input.outerWidth():0,n=c.input?c.input.outerHeight():0,s=document.documentElement.clientWidth+a(document).scrollLeft(),t=document.documentElement.clientHeight+a(document).scrollTop();b.left-=this._get(c,"isRTL")?f-p:0;b.left-=e&&b.left==c.input.offset().left?a(document).scrollLeft():
0;b.top-=e&&b.top==c.input.offset().top+n?a(document).scrollTop():0;b.left-=Math.min(b.left,b.left+f>s&&s>f?Math.abs(b.left+f-s):0);b.top-=Math.min(b.top,b.top+h>t&&t>h?Math.abs(h+n):0);return b},_findPos:function(c){for(var b=this._get(this._getInst(c),"isRTL");c&&(c.type=="hidden"||c.nodeType!=1||a.expr.filters.hidden(c));)c=c[b?"previousSibling":"nextSibling"];c=a(c).offset();return[c.left,c.top]},_hideDatepicker:function(c){var b=this._curInst;if(b&&!(c&&b!=a.data(c,"datepicker"))&&this._datepickerShowing){var c=
...
10),h=(e?e.dayNamesShort:null)||this._defaults.dayNamesShort,p=(e?e.dayNames:null)||this._defaults.dayNames,n=(e?e.monthNamesShort:null)||this._defaults.monthNamesShort,s=(e?e.monthNames:null)||this._defaults.monthNames,t=e=-1,y=-1,v=-1,u=!1,r=function(b){(b=M+1<a.length&&a.charAt(M+1)==b)&&M++;return b},A=function(a){var c=r(a),a=b.substring(H).match(RegExp("^\\d{1,"+(a=="@"?14:a=="!"?20:a=="y"&&c?4:a=="o"?3:2)+"}"));if(!a)throw"Missing number at position "+H;H+=a[0].length;return parseInt(a[0],
10)},x=function(a,c,e){a=r(a)?e:c;for(c=0;c<a.length;c++)if(b.substr(H,a[c].length).toLowerCase()==a[c].toLowerCase())return H+=a[c].length,c+1;throw"Unknown name at position "+H;},w=function(){if(b.charAt(H)!=a.charAt(M))throw"Unexpected literal at position "+H;H++},H=0,M=0;M<a.length;M++)if(u)a.charAt(M)=="'"&&!r("'")?u=!1:w();else switch(a.charAt(M)){case "d":y=A("d");break;case "D":x("D",h,p);break;case "o":v=A("o");break;case "m":t=A("m");break;case "M":t=x("M",n,s);break;case "y":e=A("y");break;
case "@":var z=new Date(A("@")),e=z.getFullYear(),t=z.getMonth()+1,y=z.getDate();break;case "!":z=new Date((A("!")-this._ticksTo1970)/1E4);e=z.getFullYear();t=z.getMonth()+1;y=z.getDate();break;case "'":r("'")?w():u=!0;break;default:w()}e==-1?e=(new Date).getFullYear():e<100&&(e+=(new Date).getFullYear()-(new Date).getFullYear()%100+(e<=f?0:-100));if(v>-1){t=1;y=v;do{f=this._getDaysInMonth(e,t-1);if(y<=f)break;t++;y-=f}while(1)}z=this._daylightSavingAdjust(new Date(e,t-1,y));if(z.getFullYear()!=e||
...
p=(e?e.monthNamesShort:null)||this._defaults.monthNamesShort,e=(e?e.monthNames:null)||this._defaults.monthNames,n=function(b){(b=u+1<a.length&&a.charAt(u+1)==b)&&u++;return b},s=function(a,c,b){c=""+c;if(n(a))for(;c.length<b;)c="0"+c;return c},t=function(a,c,b,g){return n(a)?g[c]:b[c]},y="",v=!1;if(b)for(var u=0;u<a.length;u++)if(v)a.charAt(u)=="'"&&!n("'")?v=!1:y+=a.charAt(u);else switch(a.charAt(u)){case "d":y+=s("d",b.getDate(),2);break;case "D":y+=t("D",b.getDay(),f,h);break;case "o":y+=s("o",
(b.getTime()-(new Date(b.getFullYear(),0,0)).getTime())/864E5,3);break;case "m":y+=s("m",b.getMonth()+1,2);break;case "M":y+=t("M",b.getMonth(),p,e);break;case "y":y+=n("y")?b.getFullYear():(b.getYear()%100<10?"0":"")+b.getYear()%100;break;case "@":y+=b.getTime();break;case "!":y+=b.getTime()*1E4+this._ticksTo1970;break;case "'":n("'")?y+="'":v=!0;break;default:y+=a.charAt(u)}return y},_possibleChars:function(a){for(var b="",e=!1,f=function(b){(b=h+1<a.length&&a.charAt(h+1)==b)&&h++;return b},h=0;h<
...
try{h=this.parseDate(e,f,n)||p}catch(s){this.log(s),f=b?"":f}a.selectedDay=h.getDate();a.drawMonth=a.selectedMonth=h.getMonth();a.drawYear=a.selectedYear=h.getFullYear();a.currentDay=f?h.getDate():0;a.currentMonth=f?h.getMonth():0;a.currentYear=f?h.getFullYear():0;this._adjustInstDate(a)}},_getDefaultDate:function(a){return this._restrictMinMax(a,this._determineDate(a,this._get(a,"defaultDate"),new Date))},_determineDate:function(c,b,e){var g;var f=function(a){var c=new Date;c.setDate(c.getDate()+
a);return c};if(g=(b=b==null||b===""?e:typeof b=="string"?function(b){try{return a.datepicker.parseDate(a.datepicker._get(c,"dateFormat"),b,a.datepicker._getFormatConfig(c))}catch(g){}for(var e=(b.toLowerCase().match(/^c/)?a.datepicker._getDate(c):null)||new Date,f=e.getFullYear(),h=e.getMonth(),e=e.getDate(),j=/([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,m=j.exec(b);m;){switch(m[2]||"d"){case "d":case "D":e+=parseInt(m[1],10);break;case "w":case "W":e+=parseInt(m[1],10)*7;break;case "m":case "M":h+=parseInt(m[1],
10);e=Math.min(e,a.datepicker._getDaysInMonth(f,h));break;case "y":case "Y":f+=parseInt(m[1],10),e=Math.min(e,a.datepicker._getDaysInMonth(f,h))}m=j.exec(b)}return new Date(f,h,e)}(b):typeof b=="number"?isNaN(b)?e:f(b):new Date(b.getTime()))&&b.toString()=="Invalid Date"?e:b,b=g)b.setHours(0),b.setMinutes(0),b.setSeconds(0),b.setMilliseconds(0);return this._daylightSavingAdjust(b)},_daylightSavingAdjust:function(a){if(!a)return null;a.setHours(a.getHours()>12?a.getHours()+2:0);return a},_setDate:function(a,
...
a.currentMonth,a.currentDay))},_generateHTML:function(c){var b=new Date,b=this._daylightSavingAdjust(new Date(b.getFullYear(),b.getMonth(),b.getDate())),e=this._get(c,"isRTL"),f=this._get(c,"showButtonPanel"),k=this._get(c,"hideIfNoPrevNext"),p=this._get(c,"navigationAsDateFormat"),n=this._getNumberOfMonths(c),s=this._get(c,"showCurrentAtPos"),t=this._get(c,"stepMonths"),y=n[0]!=1||n[1]!=1,v=this._daylightSavingAdjust(!c.currentDay?new Date(9999,9,9):new Date(c.currentYear,c.currentMonth,c.currentDay)),
u=this._getMinMaxDate(c,"min"),r=this._getMinMaxDate(c,"max"),s=c.drawMonth-s,A=c.drawYear;s<0&&(s+=12,A--);if(r)for(var x=this._daylightSavingAdjust(new Date(r.getFullYear(),r.getMonth()-n[0]*n[1]+1,r.getDate())),x=u&&x<u?u:x;this._daylightSavingAdjust(new Date(A,s,1))>x;)s--,s<0&&(s=11,A--);c.drawMonth=s;c.drawYear=A;var x=this._get(c,"prevText"),x=!p?x:this.formatDate(x,this._daylightSavingAdjust(new Date(A,s-t,1)),this._getFormatConfig(c)),x=this._canAdjustMonth(c,-1,A,s)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+
h+".datepicker._adjustDate('#"+c.id+"', -"+t+", 'M');\" title=\""+x+'"><span class="ui-icon ui-icon-circle-triangle-'+(e?"e":"w")+'">'+x+"</span></a>":k?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+x+'"><span class="ui-icon ui-icon-circle-triangle-'+(e?"e":"w")+'">'+x+"</span></a>",w=this._get(c,"nextText"),w=!p?w:this.formatDate(w,this._daylightSavingAdjust(new Date(A,s+t,1)),this._getFormatConfig(c)),k=this._canAdjustMonth(c,1,A,s)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+
...
(e?"right":"left");break;case n[1]-1:K+=" ui-datepicker-group-last";B=" ui-corner-"+(e?"left":"right");break;default:K+=" ui-datepicker-group-middle",B=""}K+='">'}K+='<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+B+'">'+(/all|left/.test(B)&&ba==0?e?k:x:"")+(/all|right/.test(B)&&ba==0?e?x:k:"")+this._generateMonthYearHeader(c,s,A,u,r,ba>0||I>0,M,z)+'</div><table class="ui-datepicker-calendar"><thead><tr>';for(var T=t?'<th class="ui-datepicker-week-col">'+this._get(c,"weekHeader")+
"</th>":"",B=0;B<7;B++){var D=(B+p)%7;T+="<th"+((B+p+6)%7>=5?' class="ui-datepicker-week-end"':"")+'><span title="'+w[D]+'">'+H[D]+"</span></th>"}K+=T+"</tr></thead><tbody>";T=this._getDaysInMonth(A,s);if(A==c.selectedYear&&s==c.selectedMonth)c.selectedDay=Math.min(c.selectedDay,T);for(var B=(this._getFirstDayOfMonth(A,s)-p+7)%7,T=y?6:Math.ceil((B+T)/7),D=this._daylightSavingAdjust(new Date(A,s,1-B)),O=0;O<T;O++){K+="<tr>";for(var Y=!t?"":'<td class="ui-datepicker-week-col">'+this._get(c,"calculateWeek")(D)+
"</td>",B=0;B<7;B++){var S=N?N.apply(c.input?c.input[0]:null,[D]):[!0,""],J=D.getMonth()!=s,L=J&&!W||!S[0]||u&&D<u||r&&D>r;Y+='<td class="'+((B+p+6)%7>=5?" ui-datepicker-week-end":"")+(J?" ui-datepicker-other-month":"")+(D.getTime()==G.getTime()&&s==c.selectedMonth&&c._keyEvent||Z.getTime()==D.getTime()&&Z.getTime()==G.getTime()?" "+this._dayOverClass:"")+(L?" "+this._unselectableClass+" ui-state-disabled":"")+(J&&!Q?"":" "+S[1]+(D.getTime()==v.getTime()?" "+this._currentClass:"")+(D.getTime()==b.getTime()?
" ui-datepicker-today":""))+'"'+((!J||Q)&&S[2]?' title="'+S[2]+'"':"")+(L?"":' onclick="DP_jQuery_'+h+".datepicker._selectDay('#"+c.id+"',"+D.getMonth()+","+D.getFullYear()+', this);return false;"')+">"+(J&&!Q?"&#xa0;":L?'<span class="ui-state-default">'+D.getDate()+"</span>":'<a class="ui-state-default'+(D.getTime()==b.getTime()?" ui-state-highlight":"")+(D.getTime()==v.getTime()?" ui-state-active":"")+(J?" ui-priority-secondary":"")+'" href="#">'+D.getDate()+"</a>")+"</td>";D.setDate(D.getDate()+
1);D=this._daylightSavingAdjust(D)}K+=Y+"</tr>"}s++;s>11&&(s=0,A++);K+="</tbody></table>"+(y?"</div>"+(n[0]>0&&I==n[1]-1?'<div class="ui-datepicker-row-break"></div>':""):"");F+=K}U+=F}U+=f+(a.browser.msie&&parseInt(a.browser.version,10)<7&&!c.inline?'<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>':"");c._keyEvent=!1;return U},_generateMonthYearHeader:function(c,b,e,f,k,p,n,s){var t=this._get(c,"changeMonth"),y=this._get(c,"changeYear"),v=this._get(c,"showMonthAfterYear"),
u='<div class="ui-datepicker-title">',r="";if(p||!t)r+='<span class="ui-datepicker-month">'+n[b]+"</span>";else{var n=f&&f.getFullYear()==e,A=k&&k.getFullYear()==e;r+='<select class="ui-datepicker-month" onchange="DP_jQuery_'+h+".datepicker._selectMonthYear('#"+c.id+"', this, 'M');\" onclick=\"DP_jQuery_"+h+".datepicker._clickMonthYear('#"+c.id+"');\">";for(var x=0;x<12;x++)if((!n||x>=f.getMonth())&&(!A||x<=k.getMonth()))r+='<option value="'+x+'"'+(x==b?' selected="selected"':"")+">"+s[x]+"</option>";
r+="</select>"}v||(u+=r+(p||!t||!y?"&#xa0;":""));if(!c.yearshtml)if(c.yearshtml="",p||!y)u+='<span class="ui-datepicker-year">'+e+"</span>";else{var s=this._get(c,"yearRange").split(":"),w=(new Date).getFullYear(),n=function(a){a=a.match(/c[+-].*/)?e+parseInt(a.substring(1),10):a.match(/[+-].*/)?w+parseInt(a,10):parseInt(a,10);return isNaN(a)?w:a},b=n(s[0]),s=Math.max(b,n(s[1]||"")),b=f?Math.max(b,f.getFullYear()):b,s=k?Math.min(s,k.getFullYear()):s;for(c.yearshtml+='<select class="ui-datepicker-year" onchange="DP_jQuery_'+
...
[this[0]].concat(e));return this.each(function(){typeof b=="string"?a.datepicker["_"+b+"Datepicker"].apply(a.datepicker,[this].concat(e)):a.datepicker._attachDatepicker(this,b)})};a.datepicker=new b;a.datepicker.initialized=!1;a.datepicker.uuid=(new Date).getTime();a.datepicker.version="1.8.12";window["DP_jQuery_"+h]=a})(jQuery);
(function(a,f){if(a.cleanData){var b=a.cleanData;a.cleanData=function(e){for(var c=0,f;(f=e[c])!=null;c++)a(f).triggerHandler("remove");b(e)}}else{var e=a.fn.remove;a.fn.remove=function(b,c){return this.each(function(){c||(!b||a.filter(b,[this]).length)&&a("*",this).add([this]).each(function(){a(this).triggerHandler("remove")});return e.call(a(this),b,c)})}}a.widget=function(b,c,e){var f=b.split(".")[0],j,b=b.split(".")[1];j=f+"-"+b;if(!e)e=c,c=a.Widget;a.expr[":"][j]=function(c){return!!a.data(c,
b)};a[f]=a[f]||{};a[f][b]=function(a,b){arguments.length&&this._createWidget(a,b)};c=new c;c.options=a.extend(!0,{},c.options);a[f][b].prototype=a.extend(!0,c,{namespace:f,widgetName:b,widgetEventPrefix:a[f][b].prototype.widgetEventPrefix||b,widgetBaseClass:j},e);a.widget.bridge(b,a[f][b])};a.widget.bridge=function(b,c){a.fn[b]=function(e){var m=typeof e==="string",j=Array.prototype.slice.call(arguments,1),k=this,e=!m&&j.length?a.extend.apply(null,[!0,e].concat(j)):e;if(m&&e.charAt(0)==="_")return k;
m?this.each(function(){var c=a.data(this,b),m=c&&a.isFunction(c[e])?c[e].apply(c,j):c;if(m!==c&&m!==f)return k=m,!1}):this.each(function(){var f=a.data(this,b);f?f.option(e||{})._init():a.data(this,b,new c(e,this))});return k}};a.Widget=function(a,b){arguments.length&&this._createWidget(a,b)};a.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",options:{disabled:!1},_createWidget:function(b,c){a.data(c,this.widgetName,this);this.element=a(c);this.options=a.extend(!0,{},this.options,this._getCreateOptions(),
...
$("#gis_location_addr_street").val(),g=$("#gis_location_postcode").val(),b=b||e||h||c||g?!0:!1;if((e=$("#gis_location_L"+a).val())||f){h=a==s3_gis_maxlevel?s3_gis_url+"/search.json?filter=%3D&field=level&value=nullnone":s3_gis_url+"/search.json?filter=%3D&field=level&value=L"+(a+1);e&&(h+="&parent="+e);var m;$.getJSONS3(h,function(b){if(b.length==0)m=s3_gis_empty_set;else if(!f&&a!=s3_gis_maxlevel&&b.length==1)m=s3_gis_select_location,m+='<option selected="" value="'+b[0].id+'">'+b[0].name+"</option>",
s3_gis_pullNext=!0;else{m=s3_gis_select_location;for(var c=0;c<b.length;c++)m+='<option value="'+b[c].id+'">'+b[c].name+"</option>"}a==s3_gis_maxlevel?$("#gis_location_").html(m):$("#gis_location_L"+(a+1)).html(m)},!1,!0);s3_gis_pullNext?(e=$("#gis_location_L"+(a+1)).val(),b||$("#"+s3_gis_location_id).val(e),s3_gis_dropdown_select(a+1)):b||$("#"+s3_gis_location_id).val(e)}else a!=s3_gis_maxlevel&&(s3_gis_hide_dropdown(a+1),0==a&&!b&&$("#"+s3_gis_location_id).val(""))}
...
h=$("#gis_location_addr_street").val(),c=$("#gis_location_postcode").val();s3_gis_save_location(a,b,e,h,c);return!0})}});
...
$(document).ready(function(){$("#gis_location_addr_street").after($("<button/>",{type:"button",text:"Search"}).click(function(a){var f=$("#gis_location_addr_street").val();f.length<2||(f={appid:"0Z1nFkmxg674oboTaUzdfJRSGpTJ6JF6aBxp3mZevNkw0F1ugu8nO17023D8dZFGPTqCUJysNjg-",output:"json",query:f},$("#GeoResultMenu").remove(),$.getJSON("http://geo.search.olp.yahooapis.jp/OpenLocalPlatform/V1/geoCoder?callback=?",f,function(a){if(!a||!a.Feature)$("#gis_location_addr_street_row").after($("<div/>",{id:"GeoResultMenu",
"class":"ui-menu ui-widget ui-widget-content ui-corner-all",text:"No Result matching the query..."}));else{var e=[];$.each(a.Feature,function(a,b){e.push('<li class="ui-menu-item"><a id="GeoResult_'+a+'" class="ui-corner-all">'+b.Name+"</a></li>")});$("#gis_location_addr_street_row").after($("<ul/>",{id:"GeoResultMenu","class":"ui-menu ui-widget ui-widget-content ui-corner-all",html:e.join("")}));$("#GeoResultMenu a").click(function(){var e=a.Feature[this.id.substr(10)-0].Geometry.Coordinates.split(",");
$("#gis_location_lat").val(e[1]);$("#gis_location_lon").val(e[0]);$("#gis_location_addr_street").val($(this).text());mapPanel.center=(new OpenLayers.LonLat(e[0],e[1])).transform(proj4326,projection_current);$("#GeoResultMenu").remove()})}}));a.preventDefault()}))});(function(a){a.fn.elementExists=function(){return jQuery(this).length>0}})(jQuery);(function(a){a.fn.formElementType=function(){return jQuery(this).elementExists()?jQuery(this).attr("type"):""}})(jQuery);
(function(a){a.fn.isTextBox=function(){return jQuery(this).formElementType()==="text"}})(jQuery);(function(a){a.fn.isTextArea=function(){return jQuery(this).formElementType()==="textarea"}})(jQuery);(function(a){a.fn.isPassword=function(){return jQuery(this).formElementType()==="password"}})(jQuery);(function(a){a.fn.isHiddenInput=function(){return jQuery(this).formElementType()==="hidden"}})(jQuery);(function(a){a.fn.isCheckBox=function(){return jQuery(this).formElementType()==="checkbox"}})(jQuery);
(function(a){a.fn.isRadioBox=function(){return jQuery(this).formElementType()==="radio"}})(jQuery);(function(a){a.fn.isButton=function(){return jQuery(this).formElementType()==="button"}})(jQuery);(function(a){a.fn.isSubmitButton=function(){return jQuery(this).formElementType()==="submit"}})(jQuery);(function(a){a.fn.isResetButton=function(){return jQuery(this).formElementType()==="reset"}})(jQuery);
(function(a){a.fn.isSelectBox=function(){var a=jQuery(this).formElementType(),b=this.attr("size");return a!=="select-one"?!1:typeof b==="undefined"?!1:parseInt(b)>1}})(jQuery);(function(a){a.fn.isMultiSelectBox=function(){return jQuery(this).formElementType()==="select-multiple"}})(jQuery);(function(a){a.fn.isDropDownList=function(){var a=jQuery(this).formElementType(),b=this.attr("size");return a!=="select-one"?!1:typeof b==="undefined"?!0:parseInt(b)<=1}})(jQuery);(function(a){a.fn.isChecked=function(){return jQuery(this).is(":checked")}})(jQuery);
...
y:u},j=(a.width||f.width())+60,v=(g||f.height())+60,g=Math.max(r.height/2-v/2+u,0),r=r.width/2-j/2,u=e.pageY,e=e.pageX;k.attr("curTop",u);k.attr("curLeft",e);k.attr("scaleImg",a.scaleImg?"true":"false");$("#zoom").hide().css({position:"absolute",top:u+"px",left:e+"px",width:"1px",height:"1px"});h();k.hide();a.closeOnClick&&$("#zoom").click(b);a.scaleImg?(p.html(f.html()),$("#zoom_content img").css("width","100%")):p.html("");$("#zoom").animate({top:g+"px",left:r+"px",opacity:"show",width:j,height:v},
...
(function(a){a.ui=a.ui||{};var f=/left|center|right/,b=/top|center|bottom/,e=a.fn.position,h=a.fn.offset;a.fn.position=function(c){if(!c||!c.of)return e.apply(this,arguments);var c=a.extend({},c),g=a(c.of),h=g[0],j=(c.collision||"flip").split(" "),k=c.offset?c.offset.split(" "):[0,0],p,n,s;h.nodeType===9?(p=g.width(),n=g.height(),s={top:0,left:0}):h.setTimeout?(p=g.width(),n=g.height(),s={top:g.scrollTop(),left:g.scrollLeft()}):h.preventDefault?(c.at="left top",p=n=0,s={top:c.of.pageY,left:c.of.pageX}):
(p=g.outerWidth(),n=g.outerHeight(),s=g.offset());a.each(["my","at"],function(){var a=(c[this]||"").split(" ");a.length===1&&(a=f.test(a[0])?a.concat(["center"]):b.test(a[0])?["center"].concat(a):["center","center"]);a[0]=f.test(a[0])?a[0]:"center";a[1]=b.test(a[1])?a[1]:"center";c[this]=a});j.length===1&&(j[1]=j[0]);k[0]=parseInt(k[0],10)||0;k.length===1&&(k[1]=k[0]);k[1]=parseInt(k[1],10)||0;c.at[0]==="right"?s.left+=p:c.at[0]==="center"&&(s.left+=p/2);c.at[1]==="bottom"?s.top+=n:c.at[1]==="center"&&
...
H={left:w.left-g,top:w.top-h};a.each(["left","top"],function(b,g){if(a.ui.position[j[b]])a.ui.position[j[b]][g](w,{targetWidth:p,targetHeight:n,elemWidth:e,elemHeight:f,collisionPosition:H,collisionWidth:m,collisionHeight:x,offset:k,my:c.my,at:c.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(w,{using:c.using}))})};a.ui.position={fit:{left:function(b,e){var f=a(window),f=e.collisionPosition.left+e.collisionWidth-f.width()-f.scrollLeft();b.left=f>0?b.left-f:Math.max(b.left-e.collisionPosition.left,
b.left)},top:function(b,e){var f=a(window),f=e.collisionPosition.top+e.collisionHeight-f.height()-f.scrollTop();b.top=f>0?b.top-f:Math.max(b.top-e.collisionPosition.top,b.top)}},flip:{left:function(b,e){if(e.at[0]!=="center"){var f=a(window),f=e.collisionPosition.left+e.collisionWidth-f.width()-f.scrollLeft(),h=e.my[0]==="left"?-e.elemWidth:e.my[0]==="right"?e.elemWidth:0,k=e.at[0]==="left"?e.targetWidth:-e.targetWidth,p=-2*e.offset[0];b.left+=e.collisionPosition.left<0?h+k+p:f>0?h+k+p:0}},top:function(b,
e){if(e.at[1]!=="center"){var f=a(window),f=e.collisionPosition.top+e.collisionHeight-f.height()-f.scrollTop(),h=e.my[1]==="top"?-e.elemHeight:e.my[1]==="bottom"?e.elemHeight:0,k=e.at[1]==="top"?e.targetHeight:-e.targetHeight,p=-2*e.offset[1];b.top+=e.collisionPosition.top<0?h+k+p:f>0?h+k+p:0}}}};if(!a.offset.setOffset)a.offset.setOffset=function(b,e){if(/static/.test(a.curCSS(b,"position")))b.style.position="relative";var f=a(b),h=f.offset(),k=parseInt(a.curCSS(b,"top",!0),10)||0,p=parseInt(a.curCSS(b,
"left",!0),10)||0,h={top:e.top-h.top+k,left:e.left-h.left+p};"using"in e?e.using.call(b,h):f.css(h)},a.fn.offset=function(b){var e=this[0];if(!e||!e.ownerDocument)return null;if(b)return this.each(function(){a.offset.setOffset(this,b)});return h.call(this)}})(jQuery);
(function(a){var f=0;a.widget("ui.menu",{defaultElement:"<ul>",delay:150,options:{position:{my:"left top",at:"right top"}},_create:function(){var b=this;this.activeMenu=this.element;this.menuId=this.element.attr("id")||"ui-menu-"+f++;this.element.find(".ui-icon").length&&this.element.addClass("ui-menu-icons");this.element.addClass("ui-menu ui-widget ui-widget-content ui-corner-all").attr({id:this.menuId,role:"menu"}).bind("click.menu",function(e){var f=a(e.target).closest(".ui-menu-item:has(a)");
if(b.options.disabled)return!1;f.length&&((!b.active||b.active[0]!==f[0])&&b.focus(e,f),b.select(e))}).bind("mouseover.menu",function(e){if(!b.options.disabled){var f=a(e.target).closest(".ui-menu-item");f.length&&b.focus(e,f)}}).bind("mouseout.menu",function(e){b.options.disabled||a(e.target).closest(".ui-menu-item").length&&b.blur(e)});this.refresh();this.element.attr("tabIndex",0).bind("keydown.menu",function(e){if(!b.options.disabled)switch(e.keyCode){case a.ui.keyCode.PAGE_UP:b.previousPage(e);
e.preventDefault();e.stopImmediatePropagation();break;case a.ui.keyCode.PAGE_DOWN:b.nextPage(e);e.preventDefault();e.stopImmediatePropagation();break;case a.ui.keyCode.UP:b.previous(e);e.preventDefault();e.stopImmediatePropagation();break;case a.ui.keyCode.DOWN:b.next(e);e.preventDefault();e.stopImmediatePropagation();break;case a.ui.keyCode.LEFT:b.left(e)&&e.stopImmediatePropagation();e.preventDefault();break;case a.ui.keyCode.RIGHT:b.right(e)&&e.stopImmediatePropagation();e.preventDefault();break;
case a.ui.keyCode.ENTER:b.active.children("a[aria-haspopup='true']").length?b.right(e)&&e.stopImmediatePropagation():(b.select(e),e.stopImmediatePropagation());e.preventDefault();break;case a.ui.keyCode.ESCAPE:b.left(e)&&e.stopImmediatePropagation();e.preventDefault();break;default:e.stopPropagation();clearTimeout(b.filterTimer);var f=b.previousFilter||"",c=String.fromCharCode(e.keyCode),g=!1;c==f?g=!0:c=f+c;var m=function(a){return a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")},f=b.activeMenu.children(".ui-menu-item").filter(function(){return RegExp("^"+
m(c),"i").test(a(this).children("a").text())}),f=g&&f.index(b.active.next())!=-1?b.active.nextAll(".ui-menu-item"):f;f.length||(c=String.fromCharCode(e.keyCode),f=b.activeMenu.children(".ui-menu-item").filter(function(){return RegExp("^"+m(c),"i").test(a(this).children("a").text())}));f.length?(b.focus(e,f),f.length>1?(b.previousFilter=c,b.filterTimer=setTimeout(function(){delete b.previousFilter},1E3)):delete b.previousFilter):delete b.previousFilter}})},_destroy:function(){this.element.removeAttr("aria-activedescendant").find("ul").andSelf().removeClass("ui-menu ui-widget ui-widget-content ui-corner-all").removeAttr("role").removeAttr("tabIndex").removeAttr("aria-labelledby").removeAttr("aria-expanded").removeAttr("aria-hidden").show();
this.element.find(".ui-menu-item").unbind(".menu").removeClass("ui-menu-item").removeAttr("role").children("a").removeClass("ui-corner-all ui-state-hover").removeAttr("tabIndex").removeAttr("role").removeAttr("aria-haspopup").removeAttr("id").children(".ui-icon").remove()},refresh:function(){var b=this,e=this.element.find("ul:not(.ui-menu)").addClass("ui-menu ui-widget ui-widget-content ui-corner-all").attr("role","menu").hide().attr("aria-hidden","true").attr("aria-expanded","false");e.add(this.element).children("li:not(.ui-menu-item):has(a)").addClass("ui-menu-item").attr("role",
"presentation").children("a").addClass("ui-corner-all").attr("tabIndex",-1).attr("role","menuitem").attr("id",function(a){return b.element.attr("id")+"-"+a});e.each(function(){var b=a(this),c=b.prev("a");c.attr("aria-haspopup","true").prepend('<span class="ui-menu-icon ui-icon ui-icon-carat-1-e"></span>');b.attr("aria-labelledby",c.attr("id"))})},focus:function(b,e){var f=this;this.blur();if(this._hasScroll()){var c=parseFloat(a.curCSS(this.element[0],"borderTopWidth",!0))||0,g=parseFloat(a.curCSS(this.element[0],
"paddingTop",!0))||0,c=e.offset().top-this.element.offset().top-c-g,g=this.element.scrollTop(),m=this.element.height(),j=e.height();c<0?this.element.scrollTop(g+c):c+j>m&&this.element.scrollTop(g+c-m+j)}this.active=e.first().children("a").addClass("ui-state-focus").end();f.element.attr("aria-activedescendant",f.active.children("a").attr("id"));this.active.parent().closest(".ui-menu-item").children("a:first").addClass("ui-state-active");f.timer=setTimeout(function(){f._close()},f.delay);c=a(">ul",
e);c.length&&/^mouse/.test(b.type)&&f._startOpening(c);this.activeMenu=e.parent();this._trigger("focus",b,{item:e})},blur:function(){if(this.active)clearTimeout(this.timer),this.active.children("a").removeClass("ui-state-focus"),this.active=null},_startOpening:function(a){clearTimeout(this.timer);var e=this;e.timer=setTimeout(function(){e._close();e._open(a)},e.delay)},_open:function(b){clearTimeout(this.timer);this.element.find(".ui-menu").not(b.parents()).hide().attr("aria-hidden","true");var e=
a.extend({},{of:this.active},a.type(this.options.position)=="function"?this.options.position(this.active):this.options.position);b.show().removeAttr("aria-hidden").attr("aria-expanded","true").position(e)},closeAll:function(){this.element.find("ul").hide().attr("aria-hidden","true").attr("aria-expanded","false").end().find("a.ui-state-active").removeClass("ui-state-active");this.blur();this.activeMenu=this.element},_close:function(){this.active.parent().find("ul").hide().attr("aria-hidden","true").attr("aria-expanded",
"false").end().find("a.ui-state-active").removeClass("ui-state-active")},left:function(a){var e=this.active&&this.active.parents("li:not(.ui-menubar-item)").first();if(e&&e.length)return this.active.parent().attr("aria-hidden","true").attr("aria-expanded","false").hide(),this.focus(a,e),!0},right:function(a){var e=this,f=this.active&&this.active.children("ul").children("li").first();if(f&&f.length)return this._open(f.parent()),setTimeout(function(){e.focus(a,f)},20),!0},next:function(a){this._move("next",
".ui-menu-item","first",a)},previous:function(a){this._move("prev",".ui-menu-item","last",a)},first:function(){return this.active&&!this.active.prevAll(".ui-menu-item").length},last:function(){return this.active&&!this.active.nextAll(".ui-menu-item").length},_move:function(a,e,f,c){this.active?(a=this.active[a+"All"](".ui-menu-item").eq(0),a.length?this.focus(c,a):this.focus(c,this.activeMenu.children(e)[f]())):this.focus(c,this.activeMenu.children(e)[f]())},nextPage:function(b){if(this._hasScroll())if(!this.active||
this.last())this.focus(b,this.activeMenu.children(".ui-menu-item").first());else{var e=this.active.offset().top,f=this.element.height(),c;this.active.nextAll(".ui-menu-item").each(function(){c=a(this);return a(this).offset().top-e-f<0});this.focus(b,c)}else this.focus(b,this.activeMenu.children(".ui-menu-item")[!this.active||this.last()?"first":"last"]())},previousPage:function(b){if(this._hasScroll())if(!this.active||this.first())this.focus(b,this.activeMenu.children(".ui-menu-item").last());else{var e=
this.active.offset().top,f=this.element.height(),c;this.active.prevAll(".ui-menu-item").each(function(){c=a(this);return a(this).offset().top-e+f>0});this.focus(b,c)}else this.focus(b,this.activeMenu.children(".ui-menu-item")[!this.active||this.first()?":last":":first"]())},_hasScroll:function(){return this.element.height()<this.element[a.fn.prop?"prop":"attr"]("scrollHeight")},select:function(a){var e={item:this.active};this.closeAll();this._trigger("select",a,e)}});a.ui.menu.version="@VERSION"})(jQuery);
(function(a){var f=0;a.widget("ui.autocomplete",{defaultElement:"<input>",options:{appendTo:"body",autoFocus:!1,delay:300,minLength:1,position:{my:"left top",at:"left bottom",collision:"none"},source:null,change:null,close:null,focus:null,open:null,response:null,search:null,select:null},pending:0,_create:function(){var b=this,e=this.element[0].ownerDocument,f;this.valueMethod=this.element[this.element.is("input")?"val":"text"];this.element.addClass("ui-autocomplete-input").attr("autocomplete","off").attr({role:"textbox",
"aria-autocomplete":"list","aria-haspopup":"true"}).bind("keydown.autocomplete",function(c){if(b.options.disabled||b.element.attr("readonly"))f=!0;else{f=!1;var e=a.ui.keyCode;switch(c.keyCode){case e.PAGE_UP:f=!0;b._move("previousPage",c);break;case e.PAGE_DOWN:f=!0;b._move("nextPage",c);break;case e.UP:f=!0;b._move("previous",c);c.preventDefault();break;case e.DOWN:f=!0;b._move("next",c);c.preventDefault();break;case e.ENTER:case e.NUMPAD_ENTER:b.menu.active&&(f=!0,c.preventDefault());case e.TAB:if(!b.menu.active)break;
b.menu.select(c);break;case e.ESCAPE:b._value(b.term);b.close(c);break;default:clearTimeout(b.searching),b.searching=setTimeout(function(){if(b.term!=b._value())b.selectedItem=null,b.search(null,c)},b.options.delay)}}}).bind("keypress.autocomplete",function(c){if(f)f=!1,c.preventDefault();else{var e=a.ui.keyCode;switch(c.keyCode){case e.PAGE_UP:b._move("previousPage",c);break;case e.PAGE_DOWN:b._move("nextPage",c);break;case e.UP:b._move("previous",c);c.preventDefault();break;case e.DOWN:b._move("next",
c),c.preventDefault()}}}).bind("focus.autocomplete",function(){if(!b.options.disabled)b.selectedItem=null,b.previous=b._value()}).bind("blur.autocomplete",function(a){if(!b.options.disabled)clearTimeout(b.searching),b.closing=setTimeout(function(){b.close(a);b._change(a)},150)});this._initSource();this.response=function(){return b._response.apply(b,arguments)};this.menu=a("<ul></ul>").addClass("ui-autocomplete").appendTo(a(this.options.appendTo||"body",e)[0]).mousedown(function(c){var e=b.menu.element[0];
a(c.target).closest(".ui-menu-item").length||setTimeout(function(){a(document).one("mousedown",function(c){c.target!==b.element[0]&&c.target!==e&&!a.contains(e,c.target)&&b.close()})},1);setTimeout(function(){clearTimeout(b.closing)},13)}).menu({input:a(),focus:function(a,e){var f=e.item.data("item.autocomplete");!1!==b._trigger("focus",a,{item:f})&&/^key/.test(a.originalEvent.type)&&b._value(f.value)},select:function(a,f){var h=f.item.data("item.autocomplete"),j=b.previous;if(b.element[0]!==e.activeElement)b.element.focus(),
b.previous=j,setTimeout(function(){b.previous=j;b.selectedItem=h},1);!1!==b._trigger("select",a,{item:h})&&b._value(h.value);b.term=b._value();b.close(a);b.selectedItem=h},blur:function(){b.menu.element.is(":visible")&&b._value()!==b.term&&b._value(b.term)}}).zIndex(this.element.zIndex()+1).hide().data("menu");a.fn.bgiframe&&this.menu.element.bgiframe()},_destroy:function(){this.element.removeClass("ui-autocomplete-input").removeAttr("autocomplete").removeAttr("role").removeAttr("aria-autocomplete").removeAttr("aria-haspopup");
