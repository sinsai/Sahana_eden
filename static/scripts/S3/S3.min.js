...
$(document).ready(function(){try{$('.zoom').fancyZoom({scaleImg:true,closeOnClick:true,directory:S3Ap.concat("/static/media")});}catch(e){};$('.error').hide().slideDown('slow')
...
return url_out;});$('.colorbox').click(function(){$.fn.colorbox({iframe:true,width:'99%',height:'99%',href:this.href,title:this.title});return false;});$('.tooltip').cluetip({activation:'hover',sticky:false,splitTitle:'|'});var tipCloseText='<img src="'+S3Ap.concat('/static/img/cross2.png')+'" alt="close" />'
$('.stickytip').cluetip({activation:'hover',sticky:true,closePosition:'title',closeText:tipCloseText,splitTitle:'|'});$('.ajaxtip').cluetip({activation:'click',sticky:true,closePosition:'title',closeText:tipCloseText,width:380});now=new Date();$('form').append("<input type='hidden' value="+now.getTimezoneOffset()+" name='_utc_offset'/>");});function s3_tb_remove(){$.fn.colorbox.close();}
