...
var g=$("#gis_location_name").val(),f=$("#gis_location_lat").val(),h=$("#gis_location_lon").val(),j=$("#gis_location_addr_street").val(),b=$("#gis_location_postcode").val();if(""==g){if(!((""==f||""==h)&&""==j&&""==b)){g=$("#gis_location_ :selected").text();s3_gis_loading_locations.search(g)||S3.gis.lat==$("#gis_location_lat").val()&&S3.gis.lon==$("#gis_location_lon").val()&&S3.gis.addr_street==$("#gis_location_addr_street").val().replace(/\n/g,"%0d")&&S3.gis.postcode==$("#gis_location_postcode").val()||
s3_gis_save_location(g,f,h,j,b)}return true}s3_gis_save_location(g,f,h,j,b);return true})}});
