...
function S3SetNavigateAwayConfirm(){window.onbeforeunload=function(){return _s3_msg_unsaved_changes;};};function S3ClearNavigateAwayConfirm(){window.onbeforeunload=function(){};};function S3EnableNavigateAwayConfirm(){$(document).ready(function(){$('input, select, textarea').keypress(S3SetNavigateAwayConfirm);$('input, select, textarea').change(S3SetNavigateAwayConfirm);$('form').submit(S3ClearNavigateAwayConfirm);});};