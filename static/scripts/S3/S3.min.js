...
Calendar.prototype._init=function(a,f){var b=new Date,e=b.getFullYear(),h=b.getMonth();b=b.getDate();this.table.style.visibility="hidden";var c=f.getFullYear();if(c<this.minYear)c=this.minYear,f.setFullYear(c);else if(c>this.maxYear)c=this.maxYear,f.setFullYear(c);this.firstDayOfWeek=a;this.date=new Date(f);var g=f.getMonth(),m=f.getDate();f.getMonthDays();f.setDate(1);var j=(f.getDay()-this.firstDayOfWeek)%7;j<0&&(j+=7);f.setDate(0-j);f.setDate(f.getDate()+1);j=this.tbody.firstChild;for(var k=this.ar_days=
...
Calendar.prototype.hideShowCovered=function(){function a(a){var c=a.style.visibility;c||(c=document.defaultView&&typeof document.defaultView.getComputedStyle=="function"?Calendar.is_khtml?"":document.defaultView.getComputedStyle(a,"").getPropertyValue("visibility"):a.currentStyle?a.currentStyle.visibility:"");return c}if(Calendar.is_ie||Calendar.is_opera){var f=["applet","iframe","select"],b=this.element,e=Calendar.getAbsolutePos(b),h=e.x,c=b.offsetWidth+h,g=e.y;b=b.offsetHeight+g;for(var m=f.length;m>
0;)for(var j=document.getElementsByTagName(f[--m]),k=null,p=j.length;p>0;){k=j[--p];e=Calendar.getAbsolutePos(k);var n=e.x,s=k.offsetWidth+n;e=e.y;var u=k.offsetHeight+e;if(this.hidden||n>c||s<h||e>b||u<g){if(!k.__msh_save_visibility)k.__msh_save_visibility=a(k);k.style.visibility=k.__msh_save_visibility}else{if(!k.__msh_save_visibility)k.__msh_save_visibility=a(k);k.style.visibility="hidden"}}}};
...
function(a){a.preventDefault();a=$(this);var c,g;if(a.hasClass("collapsed")){a.hasClass("fulfil")?(g="inv",c="recv"):a.hasClass("transit")?(c="send",g="inv"):a.hasClass("commit")&&(c="commit",g="req");a.after('<div class="ajax_throbber quantity_req_ajax_throbber"/>').removeClass("collapsed").addClass("expanded");var b=/req_item\/(.*)\//i.exec($(".action-btn",a.parent().parent().parent()).attr("href"))[1];b=S3.Ap.concat("/",g,"/",c,"_item_json/",b);$.ajax({url:b,dataType:"json",context:a,success:function(a){RecvTable=
...
a.lastVal){var g=this._get(a,"defaultTime"),b=this._getCurrentTimeRounded(a);g!=""&&(b=g);a.inline==!1&&a.input.val()!=""&&(b=a.input.val());g=a.lastVal=b;g=this.parseTime(a,g);a.hours=g.hours;a.minutes=g.minutes}},_getCurrentTimeRounded:function(a){var g=new Date;a=this._get(a,"timeSeparator");var b=g.getMinutes();b=Math.round(b/5)*5;return g.getHours().toString()+a+b.toString()},parseTime:function(a,g){var b={};b.hours=-1;b.minutes=-1;var e=this._get(a,"timeSeparator"),f=this._get(a,"amPmText");
e=g.indexOf(e);if(e==-1)return b;b.hours=parseInt(g.substr(0,e),10);b.minutes=parseInt(g.substr(e+1),10);e=this._get(a,"showPeriod")==!0;var h=g.toUpperCase();b.hours<12&&e&&h.indexOf(f[1].toUpperCase())!=-1&&(b.hours+=12);if(b.hours==12&&e&&h.indexOf(f[0].toUpperCase())!=-1)b.hours=0;return b},selectHours:function(c,g,b,e){c=this._getInst(a(c)[0]);a(b).parents(".ui-timepicker-hours:first").find("a").removeClass("ui-state-active");a(b).children("a").addClass("ui-state-active");c.hours=g;this._updateSelectedValue(c);
...
a.replace(/<(script|style|title)[^<]+<\/(script|style|title)>/gm,"").replace(/<(link|meta)[^>]+>/g,"")},ajaxSettings:{dataType:"html"},debug:!1};var k="appendTo",p="body";a.cluetip.setup=function(a){if(a&&a.insertionType&&a.insertionType.match(/appendTo|prependTo|insertBefore|insertAfter/))k=a.insertionType;if(a&&a.insertionElement)p=a.insertionElement}})(jQuery);var S3MultiselectWidgetFileCounter=0;
...
a(h.get(k)).addClass("hover"),e(f));return!1}if(g.keyCode==13||g.keyCode==32)return g=f.find("LABEL.hover INPUT:checkbox"),g.attr("checked",!g.attr("checked")).parent("LABEL").toggleClass("checked",g.attr("checked")),g.hasClass("selectAll")&&f.find("INPUT:checkbox").attr("checked",g.attr("checked")).parent("LABEL").addClass("checked").toggleClass("checked",g.attr("checked")),c.call(b),p&&p(a(this)),!1;if(g.keyCode>=33&&g.keyCode<=126){h=f.find("LABEL:startsWith("+String.fromCharCode(g.keyCode)+")");
var n=h.index(h.filter("LABEL.hover"));j=h.filter(function(a){return a>n});h=(j.length>=1?j:h).filter("LABEL:first");h.length==1&&(f.find("LABEL.hover").removeClass("hover"),h.addClass("hover"),e(f))}}else{if(g.keyCode==38||g.keyCode==40||g.keyCode==13||g.keyCode==32)return a(this).removeClass("focus").trigger("click"),f.find("LABEL:first").addClass("hover"),!1;if(g.keyCode==9)return f.next(":input").focus(),!0}if(g.keyCode==13)return!1})}function e(a){var c=a.find("LABEL.hover").position().top+a.find("LABEL.hover").outerHeight();
c>a.innerHeight()&&a.scrollTop(a.scrollTop()+c-a.innerHeight());a.find("LABEL.hover").position().top<0&&a.scrollTop(a.scrollTop()+a.find("LABEL.hover").position().top)}function h(c){if(a(this).data("config").optGroupSelectable){var b=!0;a(c).next().find("INPUT:checkbox").each(function(){if(!a(this).attr("checked"))return b=!1});a(c).find("INPUT.optGroup").attr("checked",b).parent("LABEL").toggleClass("checked",b)}}function c(){var c=a(this),b=c.next(".multiSelectOptions"),e=c.data("config"),f=0,h=
...
void 0)c.selectAll=!0;if(c.selectAllText==void 0)c.selectAllText="Select All";if(c.noneSelected==void 0)c.noneSelected="Select options";if(c.oneOrMoreSelected==void 0)c.oneOrMoreSelected="% selected";if(c.optGroupSelectable==void 0)c.optGroupSelectable=!1;if(c.listHeight==void 0)c.listHeight=150;a(this).each(function(){var f=a(this),h='<a href="javascript:;" class="multiSelect"><span></span></a>';h+='<div class="multiSelectOptions" style="position: absolute; z-index: 99999; visibility: hidden;"></div>';
...
0;g<h.length;g++)if(h[g]===a.val()){b=!0;break}}));return b}})(jQuery);
...
function s3_gis_convertGps(){var a=0,f=0;a=$("#gps_deg").val();f=$("#gps_min").val();var b=!1;if(a=="")a=0;else if(isNaN(a)||a>180||a<-180)alert(s3_gis_degrees_validation_error),b=!0;if(f=="")f=0;else if(isNaN(f)||f>60||f<0)alert(s3_gis_minutes_validation_error),b=!0;b==!1&&(s3_gis_calcAnswer=a>0?a*1+f/60:a*1-f/60,$("#gps_dec").val(s3_gis_calcAnswer),s3_gis_calcDone=!0)}
...
a('<span class="'+this._appendClass+'">'+b+"</span>"),c[e?"before":"after"](g.append);c.unbind("focus",this._showDatepicker);g.trigger&&g.trigger.remove();b=this._get(g,"showOn");(b=="focus"||b=="both")&&c.focus(this._showDatepicker);if(b=="button"||b=="both"){b=this._get(g,"buttonText");var f=this._get(g,"buttonImage");g.trigger=a(this._get(g,"buttonImageOnly")?a("<img/>").addClass(this._triggerClass).attr({src:f,alt:b,title:b}):a('<button type="button"></button>').addClass(this._triggerClass).html(f==
""?b:a("<img/>").attr({src:f,alt:b,title:b})));c[e?"before":"after"](g.trigger);g.trigger.click(function(){a.datepicker._datepickerShowing&&a.datepicker._lastInput==c[0]?a.datepicker._hideDatepicker():a.datepicker._showDatepicker(c[0]);return!1})}},_autoSize:function(a){if(this._get(a,"autoSize")&&!a.inline){var b=new Date(2009,11,20),e=this._get(a,"dateFormat");if(e.match(/[DM]/)){var f=function(a){for(var c=0,b=0,g=0;g<a.length;g++)if(a[g].length>c)c=a[g].length,b=g;return b};b.setMonth(f(this._get(a,
...
display:"block",top:"-1000px"});a.datepicker._updateDatepicker(b);f=a.datepicker._checkOffset(b,f,h);b.dpDiv.css({position:a.datepicker._inDialog&&a.blockUI?"static":h?"fixed":"absolute",display:"none",left:f.left+"px",top:f.top+"px"});if(!b.inline){f=a.datepicker._get(b,"showAnim");var k=a.datepicker._get(b,"duration"),p=function(){a.datepicker._datepickerShowing=!0;var c=b.dpDiv.find("iframe.ui-datepicker-cover");if(c.length){var e=a.datepicker._getBorders(b.dpDiv);c.css({left:-e[0],top:-e[1],width:b.dpDiv.outerWidth(),
...
noWeekends:function(a){a=a.getDay();return[a>0&&a<6,""]},iso8601Week:function(a){a=new Date(a.getTime());a.setDate(a.getDate()+4-(a.getDay()||7));var b=a.getTime();a.setMonth(0);a.setDate(1);return Math.floor(Math.round((b-a)/864E5)/7)+1},parseDate:function(a,b,e){if(a==null||b==null)throw"Invalid arguments";b=typeof b=="object"?b.toString():b+"";if(b=="")return null;var f=(e?e.shortYearCutoff:null)||this._defaults.shortYearCutoff;f=typeof f!="string"?f:(new Date).getFullYear()%100+parseInt(f,10);
for(var h=(e?e.dayNamesShort:null)||this._defaults.dayNamesShort,p=(e?e.dayNames:null)||this._defaults.dayNames,n=(e?e.monthNamesShort:null)||this._defaults.monthNamesShort,s=(e?e.monthNames:null)||this._defaults.monthNames,u=e=-1,w=-1,v=-1,t=!1,r=function(b){(b=O+1<a.length&&a.charAt(O+1)==b)&&O++;return b},A=function(a){var c=r(a);a=b.substring(N).match(RegExp("^\\d{1,"+(a=="@"?14:a=="!"?20:a=="y"&&c?4:a=="o"?3:2)+"}"));if(!a)throw"Missing number at position "+N;N+=a[0].length;return parseInt(a[0],
...
p=(e?e.monthNamesShort:null)||this._defaults.monthNamesShort;e=(e?e.monthNames:null)||this._defaults.monthNames;var n=function(b){(b=t+1<a.length&&a.charAt(t+1)==b)&&t++;return b},s=function(a,c,b){c=""+c;if(n(a))for(;c.length<b;)c="0"+c;return c},u=function(a,c,b,e){return n(a)?e[c]:b[c]},w="",v=!1;if(b)for(var t=0;t<a.length;t++)if(v)a.charAt(t)=="'"&&!n("'")?v=!1:w+=a.charAt(t);else switch(a.charAt(t)){case "d":w+=s("d",b.getDate(),2);break;case "D":w+=u("D",b.getDay(),f,h);break;case "o":w+=s("o",
...
try{h=this.parseDate(e,f,n)||p}catch(s){this.log(s),f=b?"":f}a.selectedDay=h.getDate();a.drawMonth=a.selectedMonth=h.getMonth();a.drawYear=a.selectedYear=h.getFullYear();a.currentDay=f?h.getDate():0;a.currentMonth=f?h.getMonth():0;a.currentYear=f?h.getFullYear():0;this._adjustInstDate(a)}},_getDefaultDate:function(a){return this._restrictMinMax(a,this._determineDate(a,this._get(a,"defaultDate"),new Date))},_determineDate:function(c,b,e){var f=function(a){var c=new Date;c.setDate(c.getDate()+a);return c};
if(b=(b=b==null||b===""?e:typeof b=="string"?function(b){try{return a.datepicker.parseDate(a.datepicker._get(c,"dateFormat"),b,a.datepicker._getFormatConfig(c))}catch(e){}var g=(b.toLowerCase().match(/^c/)?a.datepicker._getDate(c):null)||new Date,f=g.getFullYear(),h=g.getMonth();g=g.getDate();for(var j=/([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,m=j.exec(b);m;){switch(m[2]||"d"){case "d":case "D":g+=parseInt(m[1],10);break;case "w":case "W":g+=parseInt(m[1],10)*7;break;case "m":case "M":h+=parseInt(m[1],
10);g=Math.min(g,a.datepicker._getDaysInMonth(f,h));break;case "y":case "Y":f+=parseInt(m[1],10),g=Math.min(g,a.datepicker._getDaysInMonth(f,h))}m=j.exec(b)}return new Date(f,h,g)}(b):typeof b=="number"?isNaN(b)?e:f(b):new Date(b.getTime()))&&b.toString()=="Invalid Date"?e:b)b.setHours(0),b.setMinutes(0),b.setSeconds(0),b.setMilliseconds(0);return this._daylightSavingAdjust(b)},_daylightSavingAdjust:function(a){if(!a)return null;a.setHours(a.getHours()>12?a.getHours()+2:0);return a},_setDate:function(a,
...
t=this._getMinMaxDate(b,"min"),r=this._getMinMaxDate(b,"max");s=b.drawMonth-s;var A=b.drawYear;s<0&&(s+=12,A--);if(r){var x=this._daylightSavingAdjust(new Date(r.getFullYear(),r.getMonth()-n[0]*n[1]+1,r.getDate()));for(x=t&&x<t?t:x;this._daylightSavingAdjust(new Date(A,s,1))>x;)s--,s<0&&(s=11,A--)}b.drawMonth=s;b.drawYear=A;x=this._get(b,"prevText");x=!p?x:this.formatDate(x,this._daylightSavingAdjust(new Date(A,s-u,1)),this._getFormatConfig(b));x=this._canAdjustMonth(b,-1,A,s)?'<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'+
h+".datepicker._adjustDate('#"+b.id+"', -"+u+", 'M');\" title=\""+x+'"><span class="ui-icon ui-icon-circle-triangle-'+(f?"e":"w")+'">'+x+"</span></a>":k?"":'<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="'+x+'"><span class="ui-icon ui-icon-circle-triangle-'+(f?"e":"w")+'">'+x+"</span></a>";var B=this._get(b,"nextText");B=!p?B:this.formatDate(B,this._daylightSavingAdjust(new Date(A,s+u,1)),this._getFormatConfig(b));k=this._canAdjustMonth(b,1,A,s)?'<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'+
...
(f?"right":"left");break;case n[1]-1:L+=" ui-datepicker-group-last";C=" ui-corner-"+(f?"left":"right");break;default:L+=" ui-datepicker-group-middle",C=""}L+='">'}L+='<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'+C+'">'+(/all|left/.test(C)&&ba==0?f?k:x:"")+(/all|right/.test(C)&&ba==0?f?x:k:"")+this._generateMonthYearHeader(b,s,A,t,r,ba>0||I>0,O,y)+'</div><table class="ui-datepicker-calendar"><thead><tr>';var U=u?'<th class="ui-datepicker-week-col">'+this._get(b,"weekHeader")+
"</th>":"";for(C=0;C<7;C++){var E=(C+p)%7;U+="<th"+((C+p+6)%7>=5?' class="ui-datepicker-week-end"':"")+'><span title="'+B[E]+'">'+N[E]+"</span></th>"}L+=U+"</tr></thead><tbody>";U=this._getDaysInMonth(A,s);if(A==b.selectedYear&&s==b.selectedMonth)b.selectedDay=Math.min(b.selectedDay,U);C=(this._getFirstDayOfMonth(A,s)-p+7)%7;U=w?6:Math.ceil((C+U)/7);E=this._daylightSavingAdjust(new Date(A,s,1-C));for(var P=0;P<U;P++){L+="<tr>";var Y=!u?"":'<td class="ui-datepicker-week-col">'+this._get(b,"calculateWeek")(E)+
"</td>";for(C=0;C<7;C++){var S=z?z.apply(b.input?b.input[0]:null,[E]):[!0,""],K=E.getMonth()!=s,M=K&&!T||!S[0]||t&&E<t||r&&E>r;Y+='<td class="'+((C+p+6)%7>=5?" ui-datepicker-week-end":"")+(K?" ui-datepicker-other-month":"")+(E.getTime()==H.getTime()&&s==b.selectedMonth&&b._keyEvent||Z.getTime()==E.getTime()&&Z.getTime()==H.getTime()?" "+this._dayOverClass:"")+(M?" "+this._unselectableClass+" ui-state-disabled":"")+(K&&!J?"":" "+S[1]+(E.getTime()==v.getTime()?" "+this._currentClass:"")+(E.getTime()==
e.getTime()?" ui-datepicker-today":""))+'"'+((!K||J)&&S[2]?' title="'+S[2]+'"':"")+(M?"":' onclick="DP_jQuery_'+h+".datepicker._selectDay('#"+b.id+"',"+E.getMonth()+","+E.getFullYear()+', this);return false;"')+">"+(K&&!J?"&#xa0;":M?'<span class="ui-state-default">'+E.getDate()+"</span>":'<a class="ui-state-default'+(E.getTime()==e.getTime()?" ui-state-highlight":"")+(E.getTime()==v.getTime()?" ui-state-active":"")+(K?" ui-priority-secondary":"")+'" href="#">'+E.getDate()+"</a>")+"</td>";E.setDate(E.getDate()+
...
function web2py_component(a,f){jQuery(document).ready(function(){web2py_ajax_page("get",a,null,f)})}jQuery(document).ready(function(){jQuery(".s3_checkbox_label").cluetip({activation:"hover",positionBy:"auto",local:!0,hideLocal:!1,showTitle:!1,topOffset:0,mouseOutClose:!0,arrows:!0,clickThrough:!0})});
(function(a,f){a.ui=a.ui||{};var b=/left|center|right/,e=/top|center|bottom/,h=/[+-]\d+%?/,c=/^\w+/,g=/%$/,m=a.fn.position;a.fn.position=function(f){if(!f||!f.of)return m.apply(this,arguments);f=a.extend({},f);var k=a(f.of),p=k[0],n=(f.collision||"flip").split(" "),s={},u,w,v,t;p.nodeType===9?(w=k.width(),v=k.height(),t={top:0,left:0}):a.isWindow(p)?(w=k.width(),v=k.height(),t={top:k.scrollTop(),left:k.scrollLeft()}):p.preventDefault?(f.at="left top",w=v=0,t={top:f.of.pageY,left:f.of.pageX}):(w=k.outerWidth(),
...
e=c.collisionPosition.left+c.collisionWidth-e.width()-e.scrollLeft();var f=c.my[0]==="left"?-c.elemWidth:c.my[0]==="right"?c.elemWidth:0,g=c.at[0]==="left"?c.targetWidth:-c.targetWidth,h=-2*c.offset[0];b.left+=c.collisionPosition.left<0?f+g+h:e>0?f+g+h:0}},top:function(b,c){if(c.at[1]!=="center"){var e=a(window);e=c.collisionPosition.top+c.collisionHeight-e.height()-e.scrollTop();var f=c.my[1]==="top"?-c.elemHeight:c.my[1]==="bottom"?c.elemHeight:0,g=c.at[1]==="top"?c.targetHeight:-c.targetHeight,
h=-2*c.offset[1];b.top+=c.collisionPosition.top<0?f+g+h:e>0?f+g+h:0}}}};a.uiBackCompat!==!1&&function(a){var b=a.fn.position;a.fn.position=function(c){if(!c||!("offset"in c))return b.call(this,c);var e=c.offset.split(" "),g=c.at.split(" ");e.length===1&&(e[1]=e[0]);/^\d/.test(e[0])&&(e[0]="+"+e[0]);/^\d/.test(e[1])&&(e[1]="+"+e[1]);g.length===1&&(/left|center|right/.test(g[0])?g[1]="center":(g[1]=g[0],g[0]="center"));return b.call(this,a.extend(c,{at:g[0]+e[0]+" "+g[1]+e[1],offset:f}))}}(jQuery)})(jQuery);
...
0,g=parseFloat(a.curCSS(this.element[0],"paddingTop",!0))||0;c=e.offset().top-this.element.offset().top-c-g;g=this.element.attr("scrollTop");var m=this.element.height(),j=e.height();c<0?this.element.attr("scrollTop",g+c):c+j>m&&this.element.attr("scrollTop",g+c-m+j)}this.active=e.first().children("a").addClass("ui-state-focus").attr("id",function(a,b){return f.itemId=b||f.menuId+"-activedescendant"}).end();this.element.removeAttr("aria-activedescendant").attr("aria-activedescendant",f.itemId);f.timer=
...
function(c){if(!b.options.disabled&&!b.element.attr("readonly")){f=!1;var e=a.ui.keyCode;switch(c.keyCode){case e.PAGE_UP:b._move("previousPage",c);break;case e.PAGE_DOWN:b._move("nextPage",c);break;case e.UP:b._move("previous",c);c.preventDefault();break;case e.DOWN:b._move("next",c);c.preventDefault();break;case e.ENTER:case e.NUMPAD_ENTER:b.menu.active&&(f=!0,c.preventDefault());case e.TAB:if(!b.menu.active)break;b.menu.select(c);break;case e.ESCAPE:b._value(b.term);b.close(c);break;default:clearTimeout(b.searching),
b.searching=setTimeout(function(){if(b.term!=b._value())b.selectedItem=null,b.search(null,c)},b.options.delay)}}}).bind("keypress.autocomplete",function(a){f&&(f=!1,a.preventDefault())}).bind("focus.autocomplete",function(){if(!b.options.disabled)b.selectedItem=null,b.previous=b._value()}).bind("blur.autocomplete",function(a){if(!b.options.disabled)clearTimeout(b.searching),b.closing=setTimeout(function(){b.close(a);b._change(a)},150)});this._initSource();this.response=function(){return b._response.apply(b,
arguments)};this.menu=a("<ul></ul>").addClass("ui-autocomplete").appendTo(a(this.options.appendTo||"body",e)[0]).mousedown(function(c){var e=b.menu.element[0];a(c.target).closest(".ui-menu-item").length||setTimeout(function(){a(document).one("mousedown",function(c){c.target!==b.element[0]&&c.target!==e&&!a.contains(e,c.target)&&b.close()})},1);setTimeout(function(){clearTimeout(b.closing)},13)}).menu({input:a(),focus:function(a,e){var f=e.item.data("item.autocomplete");!1!==b._trigger("focus",a,{item:f})&&
/^key/.test(a.originalEvent.type)&&b._value(f.value)},select:function(a,f){var h=f.item.data("item.autocomplete"),j=b.previous;if(b.element[0]!==e.activeElement)b.element.focus(),b.previous=j,setTimeout(function(){b.previous=j;b.selectedItem=h},1);!1!==b._trigger("select",a,{item:h})&&b._value(h.value);b.term=b._value();b.close(a);b.selectedItem=h},blur:function(){b.menu.element.is(":visible")&&b._value()!==b.term&&b._value(b.term)}}).zIndex(this.element.zIndex()+1).hide().data("menu");a.fn.bgiframe&&
this.menu.element.bgiframe()},_destroy:function(){this.element.removeClass("ui-autocomplete-input").removeAttr("autocomplete").removeAttr("role").removeAttr("aria-autocomplete").removeAttr("aria-haspopup");this.menu.element.remove()},_setOption:function(b,e){this._super("_setOption",b,e);b==="source"&&this._initSource();b==="appendTo"&&this.menu.element.appendTo(a(e||"body",this.element[0].ownerDocument)[0]);b==="disabled"&&e&&this.xhr&&this.xhr.abort()},_initSource:function(){var b=this,e,h;a.isArray(this.options.source)?
(e=this.options.source,this.source=function(b,f){f(a.ui.autocomplete.filter(e,b.term))}):typeof this.options.source==="string"?(h=this.options.source,this.source=function(c,e){b.xhr&&b.xhr.abort();b.xhr=a.ajax({url:h,data:c,dataType:"json",autocompleteRequest:++f,success:function(a){this.autocompleteRequest===f&&e(a)},error:function(){this.autocompleteRequest===f&&e([])}})}):this.source=this.options.source},search:function(a,e){a=a!=null?a:this._value();this.term=this._value();if(a.length<this.options.minLength)return this.close(e);
clearTimeout(this.closing);if(this._trigger("search",e)!==!1)return this._search(a)},_search:function(a){this.pending++;this.element.addClass("ui-autocomplete-loading");this.source({term:a},this.response)},_response:function(a){a&&(a=this._normalize(a));this._trigger("response",null,{content:a});!this.options.disabled&&a&&a.length?(this._suggest(a),this._trigger("open")):this.close();this.pending--;this.pending||this.element.removeClass("ui-autocomplete-loading")},close:function(a){clearTimeout(this.closing);
this.menu.element.is(":visible")&&(this.menu.element.hide(),this.menu.blur(),this._trigger("close",a))},_change:function(a){this.previous!==this._value()&&this._trigger("change",a,{item:this.selectedItem})},_normalize:function(b){if(b.length&&b[0].label&&b[0].value)return b;return a.map(b,function(b){if(typeof b==="string")return{label:b,value:b};return a.extend({label:b.label||b.value,value:b.value||b.label},b)})},_suggest:function(b){var e=this.menu.element.empty().zIndex(this.element.zIndex()+
1);this._renderMenu(e,b);this.menu.blur();this.menu.refresh();e.show();this._resizeMenu();e.position(a.extend({of:this.element},this.options.position));this.options.autoFocus&&this.menu.next(new a.Event("mouseover"))},_resizeMenu:function(){var a=this.menu.element;a.outerWidth(Math.max(a.width("").outerWidth(),this.element.outerWidth()))},_renderMenu:function(b,e){var f=this;a.each(e,function(a,e){f._renderItem(b,e)})},_renderItem:function(b,e){return a("<li></li>").data("item.autocomplete",e).append(a("<a></a>").text(e.label)).appendTo(b)},
_move:function(a,e){if(this.menu.element.is(":visible"))if(this.menu.first()&&/^previous/.test(a)||this.menu.last()&&/^next/.test(a))this._value(this.term),this.menu.blur();else this.menu[a](e);else this.search(null,e)},widget:function(){return this.menu.element},_value:function(){return this.valueMethod.apply(this.element,arguments)}});a.extend(a.ui.autocomplete,{version:"@VERSION",escapeRegex:function(a){return a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")},filter:function(b,e){var f=RegExp(a.ui.autocomplete.escapeRegex(e),
"i");return a.grep(b,function(a){return f.test(a.label||a.value||a)})}})})(jQuery);$(document).ready(function(){S3.rtl?$('div.label label[id!="delete_record__label"]').prepend(":"):$('div.label label[id!="delete_record__label"]').append(":")});var S3={};S3.gis={};var popupWin=null;function openPopup(a){!popupWin||popupWin.closed?popupWin=window.open(a,"popupWin","width=640, height=480"):popupWin.focus()}
...
function s3_viewMap(a){a=S3.Ap.concat("/gis/display_feature/")+a;var f=$("#map").html();a="<iframe width='640' height='480' src='"+a+"'></iframe>";var b=$('<a href="#">'+S3.i18n.close_map+"</a>");b.bind("click",function(a){$("#map").html(f);a.preventDefault()});$("#map").html(a);$("#map").append($("<div style='margin-bottom: 10px' />").append(b))}
function s3_viewMapMulti(a,f,b,e){a=S3.Ap.concat("/gis/display_feature//?module=")+a+"&resource="+f+"&instance="+b+"&jresource="+e;var h=$("#map").html();a='<iframe width="640" height="480" src="'+a+'"></iframe>';f=$('<a href="#">'+S3.i18n.close_map+"</a>");f.bind("click",function(a){$("#map").html(h);a.preventDefault()});$("#map").html(a);$("#map").append($("<div style='margin-bottom: 10px' />").append(f))};
