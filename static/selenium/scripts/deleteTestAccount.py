...
class DeleteTestAccount(unittest.TestCase):
    ...
    def test_delete_test_account(self):
        sel = self.selenium
        # This test case will delete the user testing@example.com
        ...
        # Ensure that the only user displayed is testing@example.com before deleting it
        ...
        self.failUnless(re.search(r"^[\s\S]*testing@example\.com[\s\S]*$", sel.get_text("//table[@class='display']")))
