...
class TestWindow(Frame):
    ...
    def runTestSuite(self):
        ...
        self.clean = False
        self.test_main(self.getTestCasesToRun())
    ...
    def extractTests(self, moduleName): # DEPRECATED
        raise "Error"
        ...
        # but it does import the module so useful side effect
        # Now try and get the sorted list
        # this only works if the moduleName is of the form module.class
        parts = moduleName.split('.')
        if len(parts)==2:
            # Grab the loaded module and get a instance of the class
            module = sys.modules[parts[0]]
            obj = getattr(module, parts[1])
            if obj._sortList != None:
        ...
        for tests in tempTests:
            ...
            break # just a clunky mechanism to get a test out of the testsuite generated by loadTestsFromName
