...
jQuery(document).ready(function() {
    $('.form-container > form').submit(function () {
        ...
        if ( (!(datePattern.test(start_date))) | (!(datePattern.test(end_date))) ) {
            ...
            jQuery('#survey_series_start_date__row > td').last().text(error_msg);
            jQuery('#survey_series_start_date__row > td').last().addClass('red');
            return false;
        }
        ...
        if (start_date > end_date) {
            ...
            jQuery('#survey_series_end_date__row > td').last().text(error_msg);
            jQuery('#survey_series_end_date__row > td').last().addClass('red');
            return false;
        } else {
            return true;
        }
