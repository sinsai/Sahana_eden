<head>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //Resources Start        
            $('#vol_skill_Resources').css({
                'margin-left': '50px'
            }).change(function() {
                if ($('#vol_skill_Resources').attr('checked')) {
            ...
            //Restriction Start        
            $('#vol_skill_Restrictions').css({
                'margin-left': '50px'
            }).change(function() {
                if ($('#vol_skill_Restrictions').attr('checked')) {
            ...
            $('#vol_skill_Site_Manager').css({
                'margin-left': '50px'
            });
            //Unskilled Start 
            $('#vol_skill_Unskilled').css({
                'margin-left': '50px'
            }).change(function() {
                if ($('#vol_skill_Unskilled').attr('checked')) {
                    $("#vol_skill_Skill_Other__row").show();
                    $('#vol_skill_Skill_Other').css({
                        'margin-left': '50px'
                    }).change(function() {
                    ...
                    $("#vol_skill_Skill_Other").removeAttr('checked');
